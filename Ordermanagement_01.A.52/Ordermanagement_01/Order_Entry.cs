    ...
    public partial class Order_Entry : Form
    {
         ...
         //  Order_Entry.ActiveForm.Height=731;
           //treeView1.Visible = false;
            ...
            else if (userroleid == "2")
            {
                ...
                // this if for team lead user access
            if (userid == 22 || userid == 246 || userid == 89 || userid == 207)
            {
      ...
      //  }
        ...
        private void Order_Entry_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            Ordermanagement_01.Employee_Error_Entry Error = new Ordermanagement_01.Employee_Error_Entry(userid,userroleid, "", Order_Id, 3,1);
            Error.Close();
            Error.Hide();
        ...
        {
            Ordermanagement_01.Employee_Error_Entry EmployeeError = new Ordermanagement_01.Employee_Error_Entry(userid,userroleid, "", Order_Id, 3,1);
            EmployeeError.Show();
