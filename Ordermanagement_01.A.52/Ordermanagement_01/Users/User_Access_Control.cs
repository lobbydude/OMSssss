...
namespace Ordermanagement_01
{
    public partial class User_Access_Control : Form
    {
        ...
        int Cbo_Value = 0;
        int i = 0;
        public User_Access_Control(string User_Role, string user_id, string User_name)
        {
            InitializeComponent();
            Cbo_Value = 0;
        ...
        private void User_Access_Control_Load(object sender, EventArgs e)
        {
            ...
            AdminDashboard mainmenu = new AdminDashboard(User_Role_Id, userid.ToString(), username);
