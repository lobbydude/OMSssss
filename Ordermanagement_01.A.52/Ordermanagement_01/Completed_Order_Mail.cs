...
namespace Ordermanagement_01
{
    public partial class Completed_Order_Mail : Form
    {
        ...
        string Search_Path, Report_Path,Final_Path;
        
        public Completed_Order_Mail(int CLIENT_ID,string ORDER_NUMBER,int ORDER_ID,int USER_ID,int SUB_CLIENT_ID)
        {
            InitializeComponent();
            Client_Id = CLIENT_ID;
            ...
            using (MailMessage mailMessage = new MailMessage())
            {
               ...
               else if( Email_Sent_Count>0)
               {
                  ...
                  //mailMessage.To.Add("techteam@drnds.com");
                   ...
                   NetworkCred = new NetworkCredential(Email_Order_Place_Id, Email_Order_Placer_Password);
