...
namespace Ordermanagement_01.Reports
{
    ...
    public partial class Reports_Master : Form
    {
        ...
        private System.Drawing.Point pt, pt1, from_lbl, from_lbl1, to_lbl, to_lbl1, form_pt, form1_pt, report_lbl, report_lbl1, from_date, from_date1, to_date,
           ...
           , client_lbl, subpro_lbl, client_ddl, subpor_ddl, task_lbl, task_ddl;
        ...
        public Reports_Master(int user_id, string User_Roleid)
        {
            ...
            else if (Lbl_Title.Text != "")
            {
                ...
                if (fromdate <= Todate)
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        Grd_OrderTime.Columns[2].Name = "UserName";
                        Grd_OrderTime.Columns[2].HeaderText = "USER NAME";
                        Grd_OrderTime.Columns[2].DataPropertyName = "User_Name";
                        ...
                        Order_link.DisplayIndex = 3;

                        if (userroleid == "1")
                        {
                            Grd_OrderTime.Columns[3].Name = "Client";
                            Grd_OrderTime.Columns[3].HeaderText = "CLIENT NAME";
                            Grd_OrderTime.Columns[3].DataPropertyName = "Client_Name";
                            Grd_OrderTime.Columns[3].Width = 125;

                            Grd_OrderTime.Columns[4].Name = "SubProcess";
                            Grd_OrderTime.Columns[4].HeaderText = "SUB PROCESS";
                            Grd_OrderTime.Columns[4].DataPropertyName = "Sub_ProcessName";
                            Grd_OrderTime.Columns[4].Width = 250;
                        }
                        else if (userroleid == "2")
                        {
        ...
        public void Load_User_Production_Summary_Report()
        {
            ...
            if (dt_Status.Rows.Count > 0)
            {
                ...
                Grd_OrderTime.Columns[2].HeaderText = "Recived_Date";
                ...
                Grd_OrderTime.Columns[5].HeaderText = "Order_Type";
                Grd_OrderTime.Columns[5].DataPropertyName = "Order_Type";
                Grd_OrderTime.Columns[5].Width = 140;

                Grd_OrderTime.Columns[6].Name = "Borrower_Name";
                Grd_OrderTime.Columns[6].HeaderText = "Borrower_Name";
                ...
                Grd_OrderTime.Columns[8].Name = "County";
                Grd_OrderTime.Columns[8].HeaderText = "County";
                Grd_OrderTime.Columns[8].DataPropertyName = "County";
                Grd_OrderTime.Columns[8].Width = 140;



                Grd_OrderTime.Columns[9].Name = "Current_Task";
                Grd_OrderTime.Columns[9].HeaderText = "Current_Task";
                Grd_OrderTime.Columns[9].DataPropertyName = "Current_Task";
                Grd_OrderTime.Columns[9].Width = 140;

                Grd_OrderTime.Columns[10].Name = "Current_Status";
                Grd_OrderTime.Columns[10].HeaderText = "Current_Status";
                Grd_OrderTime.Columns[10].DataPropertyName = "Current_Status";
                Grd_OrderTime.Columns[10].Width = 140;

                Grd_OrderTime.Columns[11].Name = "Production_Date";
                Grd_OrderTime.Columns[11].HeaderText = "Production Date";
                Grd_OrderTime.Columns[11].DataPropertyName = "Production_Date";
                Grd_OrderTime.Columns[11].Width = 140;


                Grd_OrderTime.Columns[12].Name = "Address";
                Grd_OrderTime.Columns[12].HeaderText = "Address";
                Grd_OrderTime.Columns[12].DataPropertyName = "Address";
                Grd_OrderTime.Columns[12].Width = 140;

                Grd_OrderTime.Columns[13].Name = "Search_UserName";
                Grd_OrderTime.Columns[13].HeaderText = "SEARCH_USERNAME";
                Grd_OrderTime.Columns[13].DataPropertyName = "SEARCH_USERNAME";
                Grd_OrderTime.Columns[13].Width = 125;

                Grd_OrderTime.Columns[14].Name = "SEARCH_STATUS";
                Grd_OrderTime.Columns[14].HeaderText = "SEARCH_STATUS";
                Grd_OrderTime.Columns[14].DataPropertyName = "SEARCH_STATUS";
                Grd_OrderTime.Columns[14].Width = 195;

                Grd_OrderTime.Columns[15].Name = "SEARCH_PRODUCTION_DATE";
                Grd_OrderTime.Columns[15].HeaderText = "SEARCH_PRODUCTION_DATE";
                Grd_OrderTime.Columns[15].DataPropertyName = "SEARCH_PRODUCTION_DATE";
                Grd_OrderTime.Columns[15].Width = 125;

                Grd_OrderTime.Columns[16].Name = "SEARCH_START_TIME";
                Grd_OrderTime.Columns[16].HeaderText = "SEARCH_START_TIME";
                Grd_OrderTime.Columns[16].DataPropertyName = "SEARCH_START_TIME";
                Grd_OrderTime.Columns[16].Width = 250;

                Grd_OrderTime.Columns[17].Name = "SEARCH_END_TIME";
                Grd_OrderTime.Columns[17].HeaderText = "SEARCH_END_TIME";
                Grd_OrderTime.Columns[17].DataPropertyName = "SEARCH_END_TIME";
                Grd_OrderTime.Columns[17].Width = 180;

                Grd_OrderTime.Columns[18].Name = "TOTAL_SEARCH_TIME";
                Grd_OrderTime.Columns[18].HeaderText = "TOTAL_SEARCH_TIME";
                Grd_OrderTime.Columns[18].DataPropertyName = "TOTAL_SEARCH_TIME";
                Grd_OrderTime.Columns[18].Width = 150;

                Grd_OrderTime.Columns[19].Name = "SEARCH_QC_USERNAME";
                Grd_OrderTime.Columns[19].HeaderText = "SEARCH_QC_USERNAME";
                Grd_OrderTime.Columns[19].DataPropertyName = "SEARCH_QC_USERNAME";
                Grd_OrderTime.Columns[19].Width = 150;

                Grd_OrderTime.Columns[20].Name = "SEARCH_QC_STATUS";
                Grd_OrderTime.Columns[20].HeaderText = "SEARCH_QC_STATUS";
                Grd_OrderTime.Columns[20].DataPropertyName = "SEARCH_QC_STATUS";
                Grd_OrderTime.Columns[20].Width = 120;

                Grd_OrderTime.Columns[21].Name = "SEARCH_QC_PRODUCTION_DATE";
                Grd_OrderTime.Columns[21].HeaderText = "SEARCH_QC_PRODUCTION_DATE";
                Grd_OrderTime.Columns[21].DataPropertyName = "SEARCH_QC_PRODUCTION_DATE";
                Grd_OrderTime.Columns[21].Width = 120;

                Grd_OrderTime.Columns[22].Name = "SEARCH_QC_START_TIME";
                Grd_OrderTime.Columns[22].HeaderText = "SEARCH_QC_START_TIME";
                Grd_OrderTime.Columns[22].DataPropertyName = "SEARCH_QC_START_TIME";
                Grd_OrderTime.Columns[22].Width = 100;

                Grd_OrderTime.Columns[23].Name = "SEARCH_QC_END_TIME";
                Grd_OrderTime.Columns[23].HeaderText = "SEARCH_QC_END_TIME";
                Grd_OrderTime.Columns[23].DataPropertyName = "SEARCH_QC_END_TIME";
                Grd_OrderTime.Columns[23].Width = 100;

                Grd_OrderTime.Columns[24].Name = "TOTAL_SEARCH_QC_TIME";
                Grd_OrderTime.Columns[24].HeaderText = "TOTAL_SEARCH_QC_TIME";
                Grd_OrderTime.Columns[24].DataPropertyName = "TOTAL_SEARCH_QC_TIME";
                Grd_OrderTime.Columns[24].Width = 100;

                Grd_OrderTime.Columns[25].Name = "TYPING_USERNAME";
                Grd_OrderTime.Columns[25].HeaderText = "TYPING_USERNAME";
                Grd_OrderTime.Columns[25].DataPropertyName = "TYPING_USERNAME";
                Grd_OrderTime.Columns[25].Width = 100;

                Grd_OrderTime.Columns[26].Name = "TYPING_STATUS";
                Grd_OrderTime.Columns[26].HeaderText = "TYPING_STATUS";
                Grd_OrderTime.Columns[26].DataPropertyName = "TYPING_STATUS";
                Grd_OrderTime.Columns[26].Width = 100;

                Grd_OrderTime.Columns[27].Name = "TYPING_PRODUCTION_DATE";
                Grd_OrderTime.Columns[27].HeaderText = "TYPING_PRODUCTION_DATE";
                Grd_OrderTime.Columns[27].DataPropertyName = "TYPING_PRODUCTION_DATE";
                Grd_OrderTime.Columns[27].Width = 100;


                Grd_OrderTime.Columns[28].Name = "TYPING_START_TIME";
                Grd_OrderTime.Columns[28].HeaderText = "TYPING_START_TIME";
                Grd_OrderTime.Columns[28].DataPropertyName = "TYPING_START_TIME";
                Grd_OrderTime.Columns[28].Width = 100;

                Grd_OrderTime.Columns[29].Name = "TYPING_END_TIME";
                Grd_OrderTime.Columns[29].HeaderText = "TYPING_END_TIME";
                Grd_OrderTime.Columns[29].DataPropertyName = "TYPING_END_TIME";
                Grd_OrderTime.Columns[29].Width = 100;

                Grd_OrderTime.Columns[30].Name = "TYPING_TOTAL_TIME";
                Grd_OrderTime.Columns[30].HeaderText = "TYPING_TOTAL_TIME";
                Grd_OrderTime.Columns[30].DataPropertyName = "TYPING_TOTAL_TIME";
                Grd_OrderTime.Columns[30].Width = 100;

                Grd_OrderTime.Columns[31].Name = "TYPIG_QC_USERNAME";
                Grd_OrderTime.Columns[31].HeaderText = "TYPIG_QC_USERNAME";
                Grd_OrderTime.Columns[31].DataPropertyName = "TYPIG_QC_USERNAME";
                Grd_OrderTime.Columns[31].Width = 100;

                Grd_OrderTime.Columns[32].Name = "TYPING_QC_STATUS";
                Grd_OrderTime.Columns[32].HeaderText = "TYPING_QC_STATUS";
                Grd_OrderTime.Columns[32].DataPropertyName = "TYPING_QC_STATUS";
                Grd_OrderTime.Columns[32].Width = 100;

                Grd_OrderTime.Columns[33].Name = "TYPING_QC_PRODUCTION_DATE";
                Grd_OrderTime.Columns[33].HeaderText = "TYPING_QC_PRODUCTION_DATE";
                Grd_OrderTime.Columns[33].DataPropertyName = "TYPING_QC_PRODUCTION_DATE";
                Grd_OrderTime.Columns[33].Width = 100;


                Grd_OrderTime.Columns[34].Name = "TYPING_QC_START_TIME";
                Grd_OrderTime.Columns[34].HeaderText = "TYPING_QC_START_TIME";
                Grd_OrderTime.Columns[34].DataPropertyName = "TYPING_QC_START_TIME";
                Grd_OrderTime.Columns[34].Width = 100;

                Grd_OrderTime.Columns[35].Name = "TYPING_QC_END_TIME";
                Grd_OrderTime.Columns[35].HeaderText = "TYPING_QC_END_TIME";
                Grd_OrderTime.Columns[35].DataPropertyName = "TYPING_QC_END_TIME";
                Grd_OrderTime.Columns[35].Width = 100;

                Grd_OrderTime.Columns[36].Name = "TYPING_QC_TOTAL_TIME";
                Grd_OrderTime.Columns[36].HeaderText = "TYPING_QC_TOTAL_TIME";
                Grd_OrderTime.Columns[36].DataPropertyName = "TYPING_QC_TOTAL_TIME";
                ...
                Grd_OrderTime.Columns[37].Name = "Final_Qc_UserName";
                Grd_OrderTime.Columns[37].HeaderText = "FINAL_QC_USERNAME";
                Grd_OrderTime.Columns[37].DataPropertyName = "Final_Qc_UserName";
                Grd_OrderTime.Columns[37].Width = 100;

                Grd_OrderTime.Columns[38].Name = "Final_Qc_Progress";
                Grd_OrderTime.Columns[38].HeaderText = "FINAL_QC_STATUS";
                Grd_OrderTime.Columns[38].DataPropertyName = "Final_Qc_Progress";
                Grd_OrderTime.Columns[38].Width = 100;

                Grd_OrderTime.Columns[39].Name = "Final_Qc_Production_Date";
                Grd_OrderTime.Columns[39].HeaderText = "FINAL_QC_PRODUCTION_DATE";
                Grd_OrderTime.Columns[39].DataPropertyName = "Final_Qc_Production_Date";
                Grd_OrderTime.Columns[39].Width = 100;


                Grd_OrderTime.Columns[40].Name = "Final_Qc_Start_Time";
                Grd_OrderTime.Columns[40].HeaderText = "FINAL_QC_START_TIME";
                Grd_OrderTime.Columns[40].DataPropertyName = "Final_Qc_Start_Time";
                Grd_OrderTime.Columns[40].Width = 100;

                Grd_OrderTime.Columns[41].Name = "Final_Qc_End_Time";
                Grd_OrderTime.Columns[41].HeaderText = "FINAL_QC_END_TIME";
                Grd_OrderTime.Columns[41].DataPropertyName = "Final_Qc_End_Time";
                Grd_OrderTime.Columns[41].Width = 100;

                Grd_OrderTime.Columns[42].Name = "TOTAL_FINAL_QC_TIME";
                Grd_OrderTime.Columns[42].HeaderText = "FINAL_QC_TOTAL_TIME";
                Grd_OrderTime.Columns[42].DataPropertyName = "TOTAL_FINAL_QC_TIME";
                Grd_OrderTime.Columns[42].Width = 100;



                Grd_OrderTime.Columns[43].Name = "Exception_UserName";
                Grd_OrderTime.Columns[43].HeaderText = "EXCEPTION_USERNAME";
                Grd_OrderTime.Columns[43].DataPropertyName = "Exception_UserName";
                Grd_OrderTime.Columns[43].Width = 100;

                Grd_OrderTime.Columns[44].Name = "Exception_Progress";
                Grd_OrderTime.Columns[44].HeaderText = "EXCEPTION_STATUS";
                Grd_OrderTime.Columns[44].DataPropertyName = "Exception_Progress";
                Grd_OrderTime.Columns[44].Width = 100;

                Grd_OrderTime.Columns[45].Name = "Exception_Production_Date";
                Grd_OrderTime.Columns[45].HeaderText = "EXCEPTION_PRODUCTION_DATE";
                Grd_OrderTime.Columns[45].DataPropertyName = "Exception_Production_Date";
                Grd_OrderTime.Columns[45].Width = 100;


                Grd_OrderTime.Columns[46].Name = "Exception_Start_Time";
                Grd_OrderTime.Columns[46].HeaderText = "EXCEPTION_START_TIME";
                Grd_OrderTime.Columns[46].DataPropertyName = "Exception_Start_Time";
                Grd_OrderTime.Columns[46].Width = 100;

                Grd_OrderTime.Columns[47].Name = "Exception_End_Time";
                Grd_OrderTime.Columns[47].HeaderText = "EXCEPTION_END_TIME";
                Grd_OrderTime.Columns[47].DataPropertyName = "Exception_End_Time";
                Grd_OrderTime.Columns[47].Width = 100;

                Grd_OrderTime.Columns[48].Name = "TOTAL_EXCEPTION_TIME";
                Grd_OrderTime.Columns[48].HeaderText = "EXCEPTION_TOTAL_TIME";
                Grd_OrderTime.Columns[48].DataPropertyName = "TOTAL_EXCEPTION_TIME";
                ...
                Grd_OrderTime.Columns[49].Name = "UPLOAD_USERNAME";
                Grd_OrderTime.Columns[49].HeaderText = "UPLOAD_USERNAME";
                Grd_OrderTime.Columns[49].DataPropertyName = "UPLOAD_USERNAME";
                Grd_OrderTime.Columns[49].Width = 100;

                Grd_OrderTime.Columns[50].Name = "UPLOAD_STATUS";
                Grd_OrderTime.Columns[50].HeaderText = "UPLOAD_STATUS";
                Grd_OrderTime.Columns[50].DataPropertyName = "UPLOAD_STATUS";
                Grd_OrderTime.Columns[50].Width = 100;

                Grd_OrderTime.Columns[51].Name = "UPLOAD_PRODUCTION_DATE";
                Grd_OrderTime.Columns[51].HeaderText = "UPLOAD_PRODUCTION_DATE";
                Grd_OrderTime.Columns[51].DataPropertyName = "UPLOAD_PRODUCTION_DATE";
                Grd_OrderTime.Columns[51].Width = 100;

                Grd_OrderTime.Columns[52].Name = "UPLOAD_START_TIME";
                Grd_OrderTime.Columns[52].HeaderText = "UPLOAD_START_TIME";
                Grd_OrderTime.Columns[52].DataPropertyName = "UPLOAD_START_TIME";
                Grd_OrderTime.Columns[52].Width = 100;

                Grd_OrderTime.Columns[53].Name = "UPLOAD_END_TIME";
                Grd_OrderTime.Columns[53].HeaderText = "UPLOAD_END_TIME";
                Grd_OrderTime.Columns[53].DataPropertyName = "UPLOAD_END_TIME";
                Grd_OrderTime.Columns[53].Width = 100;

                Grd_OrderTime.Columns[54].Name = "TOTAL_UPLAODING_TIME";
                Grd_OrderTime.Columns[54].HeaderText = "TOTAL_UPLAODING_TIME";
                Grd_OrderTime.Columns[54].DataPropertyName = "TOTAL_UPLAODING_TIME";
                Grd_OrderTime.Columns[54].Width = 100;

                Grd_OrderTime.Columns[55].Name = "Search";
                Grd_OrderTime.Columns[55].HeaderText = "Search Cooments";
                Grd_OrderTime.Columns[55].DataPropertyName = "Search";
                Grd_OrderTime.Columns[55].Width = 100;


                Grd_OrderTime.Columns[56].Name = "Search_Qc";
                Grd_OrderTime.Columns[56].HeaderText = "Search_Qc_Comments";
                Grd_OrderTime.Columns[56].DataPropertyName = "Search_Qc";
                Grd_OrderTime.Columns[56].Width = 100;


                Grd_OrderTime.Columns[57].Name = "Typing";
                Grd_OrderTime.Columns[57].HeaderText = "Typing_Comments";
                Grd_OrderTime.Columns[57].DataPropertyName = "Typing";
                Grd_OrderTime.Columns[57].Width = 100;




                Grd_OrderTime.Columns[58].Name = "Typing_Qc";
                Grd_OrderTime.Columns[58].HeaderText = "Typing_Qc_Comments";
                Grd_OrderTime.Columns[58].DataPropertyName = "Typing_Qc";
                Grd_OrderTime.Columns[58].Width = 100;

                Grd_OrderTime.Columns[59].Name = "Final_Qc";
                Grd_OrderTime.Columns[59].HeaderText = "FInal_Comments";
                Grd_OrderTime.Columns[59].DataPropertyName = "Final_Qc";
                Grd_OrderTime.Columns[59].Width = 100;



                Grd_OrderTime.Columns[60].Name = "Upload";
                Grd_OrderTime.Columns[60].HeaderText = "Upload_Comments";
                Grd_OrderTime.Columns[60].DataPropertyName = "Upload";
                Grd_OrderTime.Columns[60].Width = 100;

                Grd_OrderTime.Columns[61].Name = "Exception";
                Grd_OrderTime.Columns[61].HeaderText = "Exception_Comments";
                Grd_OrderTime.Columns[61].DataPropertyName = "Exception";
        ...
        public void Load_Date_Wise_Order_Status_Report()
        {
            ...
            if (dt_Status.Rows.Count > 0)
            {
                ...
                Grd_OrderTime.Columns[11].HeaderText = "Current Task";
                ...
                Grd_OrderTime.Columns[19].HeaderText = "Abstractor_Cost";
        ...
        public void Load_Billing_Report()
        {
            ...
            if (dt_Status.Rows.Count > 0)
            {
                ...
                Grd_OrderTime.Columns[14].Name = "County_type";
                Grd_OrderTime.Columns[14].HeaderText = "County type";
                Grd_OrderTime.Columns[14].DataPropertyName = "County_Type";
                Grd_OrderTime.Columns[14].Width = 100;

                Grd_OrderTime.Columns[15].Name = "Source";
                Grd_OrderTime.Columns[15].HeaderText = "Source";
                Grd_OrderTime.Columns[15].DataPropertyName = "Source";
                Grd_OrderTime.Columns[15].Width = 100;

                Grd_OrderTime.Columns[16].Name = "Order_Cost";
                Grd_OrderTime.Columns[16].HeaderText = "Order Cost";
                Grd_OrderTime.Columns[16].DataPropertyName = "Order_Cost";
                Grd_OrderTime.Columns[16].Width = 100;
                ...
                Grd_OrderTime.Columns[24].Name = "Effectivedate";
                Grd_OrderTime.Columns[24].HeaderText = "Effective_date";
                Grd_OrderTime.Columns[24].DataPropertyName = "Effective_date";
                Grd_OrderTime.Columns[24].Width = 100;
                ...
                Grd_OrderTime.Columns[25].Width = 100;
                //Grd_OrderTime.Columns[12].Name = "OrderId";
                //Grd_OrderTime.Columns[12].HeaderText = "Order Id";
                //Grd_OrderTime.Columns[12].DataPropertyName = "Order_ID";
                //Grd_OrderTime.Columns[12].Visible = false;
        ...
        public void Load_Order_Document_List_Report()
        {
            ...
            if (dt_Status.Rows.Count > 0)
            {
                ...
                //Grd_OrderTime.Columns[12].HeaderText = "User Name";
                //Grd_OrderTime.Columns[12].DataPropertyName = "User_Name";
                //Grd_OrderTime.Columns[12].Width = 100;

                //Grd_OrderTime.Columns[12].Name = "Order_Production_Date";
                //Grd_OrderTime.Columns[12].HeaderText = "Order Production Date";
                //Grd_OrderTime.Columns[12].DataPropertyName = "Order_Production_Date";
                //Grd_OrderTime.Columns[12].Width = 100;

                //Grd_OrderTime.Columns[12].Name = "Additional";
                //Grd_OrderTime.Columns[12].HeaderText = "Additional";
                //Grd_OrderTime.Columns[12].DataPropertyName = "Additional";
                //Grd_OrderTime.Columns[12].Width = 100;

                //Grd_OrderTime.Columns[12].Name = "Assignment";
                //Grd_OrderTime.Columns[12].HeaderText = "Assignment";
                //Grd_OrderTime.Columns[12].DataPropertyName = "Assignment";
                //Grd_OrderTime.Columns[12].Width = 100;

                //Grd_OrderTime.Columns[12].Name = "CCR";
                //Grd_OrderTime.Columns[12].HeaderText = "CCR";
                //Grd_OrderTime.Columns[12].DataPropertyName = "CCR";
                //Grd_OrderTime.Columns[12].Width = 100;

                //Grd_OrderTime.Columns[12].Name = "Easement";
                //Grd_OrderTime.Columns[12].HeaderText = "Easement";
                //Grd_OrderTime.Columns[12].DataPropertyName = "Easement";
                //Grd_OrderTime.Columns[12].Width = 100;

                //Grd_OrderTime.Columns[12].Name = "Federal Taxes";
                //Grd_OrderTime.Columns[12].HeaderText = "Federal Taxes";
                //Grd_OrderTime.Columns[12].DataPropertyName = "Federal Taxes";
                //Grd_OrderTime.Columns[12].Width = 100;
        ...
        private void Order_Chklist_Design()
        {
            ...
            from_lbl.X = 317; from_lbl.Y = 40;
            pt1.X = 418; pt1.Y = 40;
            to_lbl.X = 619; to_lbl.Y = 45;
            pt.X = 743; pt.Y = 41;

            client_lbl.X = 304; client_lbl.Y = 82;
            ...
            if (e.RowIndex != -1)
            {
                if (tvwRightSide.SelectedNode.Text == "Billing Report")
                {
                    ...
                    if (e.ColumnIndex == 26)
                    {
                        ...
                        Ordermanagement_01.Order_Entry OrderEntry = new Ordermanagement_01.Order_Entry(int.Parse(Grd_OrderTime.Rows[e.RowIndex].Cells[0].Value.ToString()), User_id, userroleid);
                        OrderEntry.Show();
                    }
                    //cProbar.stopProgress();
                }
                ...
                else if (tvwRightSide.SelectedNode.Text == "User Production Report")
                {
                    ...
                    if (e.ColumnIndex == 12)
                    {
                        ...
                        Ordermanagement_01.Order_Entry OrderEntry = new Ordermanagement_01.Order_Entry(int.Parse(Grd_OrderTime.Rows[e.RowIndex].Cells[11].Value.ToString()), User_id, userroleid);
                        OrderEntry.Show();
                    }
                    //cProbar.stopProgress();
                }
                ...
                else if (tvwRightSide.SelectedNode.Text == "Order Source Report")
                {
                    ...
                    if (e.ColumnIndex == 1)
                    {
                        ...
                        {
                            //Clientid
                            Ordermanagement_01.Order_Entry view = new Ordermanagement_01.Order_Entry(clientid, User_id, userroleid);
                            view.Show();
                        }

                        else if (ordersourceid != 1 && ordersourceid != 2 && ordersourceid != 3 && ordersourceid != 4)
                        {
                            Ordermanagement_01.Reports.Report_Order_Source_view rpt_ordersource = new Ordermanagement_01.Reports.Report_Order_Source_view(User_id, userroleid, clientid, headertext, ordersourceid, ddl_Client_Status.Text, txt_Fromdate.Text, txt_Todate.Text, clientname, userroleid);
                ...
                else if (tvwRightSide.SelectedNode.Text == "Order Received Date Report")
                {
                    ...
                    if (e.ColumnIndex != 0 && e.ColumnIndex != 1)
                    {
                        ...
                        Ordermanagement_01.Reports.Report_Order_Source_view rpt_ordersource = new Ordermanagement_01.Reports.Report_Order_Source_view(User_id, userroleid, clientid, headertext, 0, "", "", "", "",userroleid);
                        rpt_ordersource.Show();
                    }
                }
                else if (tvwRightSide.SelectedNode.Text == "Order Task wise Report")
                {
                    ...
                    if (e.ColumnIndex == 0)
                    {
                        ...
                        {
                            //SEARCH ORDER SHOW
                            Ordermanagement_01.Reports.Order_Report_View search = new Ordermanagement_01.Reports.Order_Report_View(2, int.Parse(ddl_Client_Status.SelectedValue.ToString()), From_date, To_date, User_id, userroleid);
                            search.Show();
                        }
                        else if (Grd_OrderTime.Rows[e.RowIndex].Cells[0].Value.ToString() == "SEARCH QC")
                        {
                            //SEARCH QC ORDER SHOW
                            Ordermanagement_01.Reports.Order_Report_View search = new Ordermanagement_01.Reports.Order_Report_View(3, int.Parse(ddl_Client_Status.SelectedValue.ToString()), From_date, To_date,User_id, userroleid);
                            search.Show();
                        }
                        else if (Grd_OrderTime.Rows[e.RowIndex].Cells[0].Value.ToString() == "TYPING")
                        {
                            //TYPING ORDER SHOW
                            Ordermanagement_01.Reports.Order_Report_View search = new Ordermanagement_01.Reports.Order_Report_View(4, int.Parse(ddl_Client_Status.SelectedValue.ToString()), From_date, To_date, User_id, userroleid);
                            search.Show();
                        }
                        else if (Grd_OrderTime.Rows[e.RowIndex].Cells[0].Value.ToString() == "TYPING QC")
                        {
                            //TYPING QC ORDER SHOW
                            Ordermanagement_01.Reports.Order_Report_View search = new Ordermanagement_01.Reports.Order_Report_View(7, int.Parse(ddl_Client_Status.SelectedValue.ToString()), From_date, To_date, User_id, userroleid);
                            search.Show();
                        }
                        else if (Grd_OrderTime.Rows[e.RowIndex].Cells[0].Value.ToString() == "UPLOAD")
                        {
                            //UPLOAD ORDER SHOW
                            Ordermanagement_01.Reports.Order_Report_View search = new Ordermanagement_01.Reports.Order_Report_View(12, int.Parse(ddl_Client_Status.SelectedValue.ToString()), From_date, To_date, User_id, userroleid);
                            search.Show();
                        }
                ...
                else if (tvwRightSide.SelectedNode.Text == "Client Wise Production Count")
                {
                    ...
                    if (e.ColumnIndex == 1)
                    {
                        ...
                        if (Pass_Sub_Process_Id != 0)
                        {
                            ...
                            Ordermanagement_01.Order_View OrderEntry = new Ordermanagement_01.Order_View(Grd_OrderTime.Rows[e.RowIndex].Cells[16].Value.ToString(), "GET_RECIVD_ORDER_DATE_WISE_SUB_CLIENT", "GET_RECIVED_ORDER_DATEWISE_SUB_CLIENT_WISE_COUNT", txt_Fromdate.Text, txt_Todate.Text, User_id, Sub_Process_Id, userroleid);
                            OrderEntry.Show();
                        }
                        else
                        {
                            ...
                            Sub_Process_Id = 0;
                            Ordermanagement_01.Order_View OrderEntry = new Ordermanagement_01.Order_View(Grd_OrderTime.Rows[e.RowIndex].Cells[16].Value.ToString(), "GET_RECIVD_ORDER_DATE_WISE", "GET_RECIVED_ORDER_DATEWISE_COUNT", txt_Fromdate.Text, txt_Todate.Text, User_id, Sub_Process_Id, userroleid);
                            OrderEntry.Show();
                        }
                    ...
                    else if (e.ColumnIndex == 2)
                    {
                        ...
                        if (Pass_Sub_Process_Id != 0)
                        {
                            ...
                            Sub_Process_Id = int.Parse(Grd_OrderTime.Rows[e.RowIndex].Cells[17].Value.ToString());
                            Ordermanagement_01.Order_View OrderEntry = new Ordermanagement_01.Order_View(Grd_OrderTime.Rows[e.RowIndex].Cells[16].Value.ToString(), "GET_RECIVD_ORDER_MTD_WISE_SUB_CLIENT_WISE", "GET_RECIVED_MTD_ORDER_MISE_COUNT_SUB_CLIENT", txt_Fromdate.Text, txt_Todate.Text, User_id, Sub_Process_Id, userroleid);
                            OrderEntry.Show();
                        }
                        else
                        {
                            ...
                            Sub_Process_Id = 0;
                            Ordermanagement_01.Order_View OrderEntry = new Ordermanagement_01.Order_View(Grd_OrderTime.Rows[e.RowIndex].Cells[16].Value.ToString(), "GET_RECIVD_ORDER_MTD_WISE", "GET_RECIVED_MTD_ORDER_MISE_COUNT", txt_Fromdate.Text, txt_Todate.Text, User_id, Sub_Process_Id, userroleid);
                            OrderEntry.Show();
                        }
                    ...
                    else if (e.ColumnIndex == 3)
                    {
                        if (Pass_Sub_Process_Id != 0)
                        {
                            ...
                            Sub_Process_Id = int.Parse(Grd_OrderTime.Rows[e.RowIndex].Cells[17].Value.ToString());
                            Ordermanagement_01.Order_View OrderEntry = new Ordermanagement_01.Order_View(Grd_OrderTime.Rows[e.RowIndex].Cells[16].Value.ToString(), "GET_COMPLETED_ORDER_DATE_SUB_CLIENT_WISE", "GET_COMPLETED_ORDER_DATE_WISE_COUNT_SUB_CLIENT_WISE", txt_Fromdate.Text, txt_Todate.Text, User_id, Sub_Process_Id, userroleid);
                            OrderEntry.Show();
                        }
                        else
                        {
                            ...
                            Sub_Process_Id = 0;
                            Ordermanagement_01.Order_View OrderEntry = new Ordermanagement_01.Order_View(Grd_OrderTime.Rows[e.RowIndex].Cells[16].Value.ToString(), "GET_COMPLETED_ORDER_DATE_WISE", "GET_COMPLETED_ORDER_DATE_WISE_COUNT", txt_Fromdate.Text, txt_Todate.Text, User_id, Sub_Process_Id, userroleid);
                            OrderEntry.Show();
                        }
                    ...
                    else if (e.ColumnIndex == 4)
                    {
                        if (Pass_Sub_Process_Id != 0)
                        {
                            ...
                            Sub_Process_Id = int.Parse(Grd_OrderTime.Rows[e.RowIndex].Cells[17].Value.ToString());
                            Ordermanagement_01.Order_View OrderEntry = new Ordermanagement_01.Order_View(Grd_OrderTime.Rows[e.RowIndex].Cells[16].Value.ToString(), "GET_COMPLETED_ORDER_MTD_WISE_SUB_PROCESS_WISE", "GET_COMPLETED_ORDER_MTD_WISE_COUNT_SUB_PROCESS_WISE", txt_Fromdate.Text, txt_Todate.Text, User_id, Sub_Process_Id, userroleid);
                            OrderEntry.Show();
                        }
                        else
                        {
                            ...
                            Sub_Process_Id = 0;
                            Ordermanagement_01.Order_View OrderEntry = new Ordermanagement_01.Order_View(Grd_OrderTime.Rows[e.RowIndex].Cells[16].Value.ToString(), "GET_COMPLETED_ORDER_MTD_WISE", "GET_COMPLETED_ORDER_MTD_WISE_COUNT", txt_Fromdate.Text, txt_Todate.Text, User_id, Sub_Process_Id, userroleid);
                            OrderEntry.Show();
                        }
                    ...
                    else if (e.ColumnIndex == 5)
                    {
                        if (Pass_Sub_Process_Id != 0)
                        {
                            ...
                            Sub_Process_Id = int.Parse(Grd_OrderTime.Rows[e.RowIndex].Cells[17].Value.ToString());
                            Ordermanagement_01.Order_View OrderEntry = new Ordermanagement_01.Order_View(Grd_OrderTime.Rows[e.RowIndex].Cells[16].Value.ToString(), "GET_SEARCH_ORDER_SUB_PROCESS_WISE", "GET_SEARCH_ORDER_COUNT_SUB_PROCESS_WISE", txt_Fromdate.Text, txt_Todate.Text, User_id, Sub_Process_Id, userroleid);
                            OrderEntry.Show();
                        }
                        else
                        {
                            ...
                            Sub_Process_Id = 0;
                            Ordermanagement_01.Order_View OrderEntry = new Ordermanagement_01.Order_View(Grd_OrderTime.Rows[e.RowIndex].Cells[16].Value.ToString(), "GET_SEARCH_ORDER", "GET_SEARCH_ORDER_COUNT", txt_Fromdate.Text, txt_Todate.Text, User_id, Sub_Process_Id, userroleid);
                            OrderEntry.Show();
                        }
                    ...
                    else if (e.ColumnIndex == 6)
                    {
                        if (Pass_Sub_Process_Id != 0)
                        {
                            ...
                            Sub_Process_Id = int.Parse(Grd_OrderTime.Rows[e.RowIndex].Cells[17].Value.ToString());
                            Ordermanagement_01.Order_View OrderEntry = new Ordermanagement_01.Order_View(Grd_OrderTime.Rows[e.RowIndex].Cells[16].Value.ToString(), "GET_SEARCH_QC_ORDER_SUB_CLIENT_WISE", "GET_SEARCH_QC_ORDER_COUNT_SUB_PROCESS_WISE", txt_Fromdate.Text, txt_Todate.Text, User_id, Sub_Process_Id, userroleid);
                            OrderEntry.Show();
                        }
                        else
                        {
                            ...
                            Sub_Process_Id = 0;
                            Ordermanagement_01.Order_View OrderEntry = new Ordermanagement_01.Order_View(Grd_OrderTime.Rows[e.RowIndex].Cells[16].Value.ToString(), "GET_SEARCH_QC_ORDER", "GET_SEARCH_QC_ORDER_COUNT", txt_Fromdate.Text, txt_Todate.Text, User_id, Sub_Process_Id, userroleid);
                            OrderEntry.Show();
                        }
                    ...
                    else if (e.ColumnIndex == 7)
                    {
                        if (Pass_Sub_Process_Id != 0)
                        {
                            ...
                            Sub_Process_Id = int.Parse(Grd_OrderTime.Rows[e.RowIndex].Cells[17].Value.ToString());
                            Ordermanagement_01.Order_View OrderEntry = new Ordermanagement_01.Order_View(Grd_OrderTime.Rows[e.RowIndex].Cells[16].Value.ToString(), "GET_TYPING_ORDER_SUB_PROCESS_WISE", "GET_TYPING_ORDER_COUNT_SUB_PROCESS_WISE", txt_Fromdate.Text, txt_Todate.Text, User_id, Sub_Process_Id, userroleid);
                            OrderEntry.Show();
                        }
                        else
                        {
                            ...
                            Sub_Process_Id = 0;
                            Ordermanagement_01.Order_View OrderEntry = new Ordermanagement_01.Order_View(Grd_OrderTime.Rows[e.RowIndex].Cells[16].Value.ToString(), "GET_TYPING_ORDER", "GET_TYPING_ORDER_COUNT", txt_Fromdate.Text, txt_Todate.Text, User_id, Sub_Process_Id, userroleid);
                            OrderEntry.Show();
                        }
                    ...
                    else if (e.ColumnIndex == 8)
                    {
                        if (Pass_Sub_Process_Id != 0)
                        {
                            ...
                            Sub_Process_Id = int.Parse(Grd_OrderTime.Rows[e.RowIndex].Cells[17].Value.ToString());
                            Ordermanagement_01.Order_View OrderEntry = new Ordermanagement_01.Order_View(Grd_OrderTime.Rows[e.RowIndex].Cells[16].Value.ToString(), "GET_TYPING_QC_ORDER_SUB_PROCESS_WIESE", "GET_TYPING_QC_ORDER_COUNT_SUB_PROCESS_WISE", txt_Fromdate.Text, txt_Todate.Text, User_id, Sub_Process_Id, userroleid);
                            OrderEntry.Show();
                        }
                        else
                        {
                            ...
                            Sub_Process_Id = 0;
                            Ordermanagement_01.Order_View OrderEntry = new Ordermanagement_01.Order_View(Grd_OrderTime.Rows[e.RowIndex].Cells[16].Value.ToString(), "GET_TYPING_QC_ORDER", "GET_TYPING_QC_ORDER_COUNT", txt_Fromdate.Text, txt_Todate.Text, User_id, Sub_Process_Id, userroleid);
                            OrderEntry.Show();
                        }
                    ...
                    else if (e.ColumnIndex == 9)
                    {
                        if (Pass_Sub_Process_Id != 0)
                        {
                            ...
                            Sub_Process_Id = int.Parse(Grd_OrderTime.Rows[e.RowIndex].Cells[17].Value.ToString());
                            Ordermanagement_01.Order_View OrderEntry = new Ordermanagement_01.Order_View(Grd_OrderTime.Rows[e.RowIndex].Cells[16].Value.ToString(), "GET_UPLOAD_ORDER_SUB_PROCESS_WISE", "UPLOAD_ORDER_COUNT_SUB_PROCESS_WISE", txt_Fromdate.Text, txt_Todate.Text, User_id, Sub_Process_Id, userroleid);
                            OrderEntry.Show();
                        }
                        else
                        {
                            ...
                            Sub_Process_Id = 0;
                            Ordermanagement_01.Order_View OrderEntry = new Ordermanagement_01.Order_View(Grd_OrderTime.Rows[e.RowIndex].Cells[16].Value.ToString(), "GET_UPLOAD_ORDER", "UPLOAD_ORDER_COUNT", txt_Fromdate.Text, txt_Todate.Text, User_id, Sub_Process_Id, userroleid);
                            OrderEntry.Show();
                        }
                    ...
                    else if (e.ColumnIndex == 10)
                    {
                        if (Pass_Sub_Process_Id != 0)
                        {
                            ...
                            Sub_Process_Id = int.Parse(Grd_OrderTime.Rows[e.RowIndex].Cells[17].Value.ToString());
                            Ordermanagement_01.Order_View OrderEntry = new Ordermanagement_01.Order_View(Grd_OrderTime.Rows[e.RowIndex].Cells[16].Value.ToString(), "GET_ABSTRACTOR_ORDER_SUB_PROCESS_WISE", "GET_ABSTRATCOR_ORDER_COUNT_SUB_PROCESS_WISE", txt_Fromdate.Text, txt_Todate.Text, User_id, Sub_Process_Id, userroleid);
                            OrderEntry.Show();
                        }
                        else
                        {
                            ...
                            Sub_Process_Id = 0;
                            Ordermanagement_01.Order_View OrderEntry = new Ordermanagement_01.Order_View(Grd_OrderTime.Rows[e.RowIndex].Cells[16].Value.ToString(), "GET_ABSTRACTOR_ORDER", "GET_ABSTRATCOR_ORDER_COUNT", txt_Fromdate.Text, txt_Todate.Text, User_id, Sub_Process_Id, userroleid);
                            OrderEntry.Show();
                        }
                    ...
                    else if (e.ColumnIndex == 11)
                    {
                        if (Pass_Sub_Process_Id != 0)
                        {
                            ...
                            Sub_Process_Id = int.Parse(Grd_OrderTime.Rows[e.RowIndex].Cells[17].Value.ToString());
                            Ordermanagement_01.Order_View OrderEntry = new Ordermanagement_01.Order_View(Grd_OrderTime.Rows[e.RowIndex].Cells[16].Value.ToString(), "GET_AFA_ORDER_SUB_PROCESS_WISE", "AFA_ORDER_COUNT_SUB_RPOCESS_WIESE", txt_Fromdate.Text, txt_Todate.Text, User_id, Sub_Process_Id, userroleid);
                            OrderEntry.Show();
                        }
                        else
                        {
                            ...
                            Sub_Process_Id = 0;
                            Ordermanagement_01.Order_View OrderEntry = new Ordermanagement_01.Order_View(Grd_OrderTime.Rows[e.RowIndex].Cells[16].Value.ToString(), "GET_AFA_ORDER", "AFA_ORDER_COUNT", txt_Fromdate.Text, txt_Todate.Text, User_id, Sub_Process_Id, userroleid);
                            OrderEntry.Show();
                        }
                    ...
                    else if (e.ColumnIndex == 12)
                    {
                        if (Pass_Sub_Process_Id != 0)
                        {
                            ...
                            Sub_Process_Id = int.Parse(Grd_OrderTime.Rows[e.RowIndex].Cells[17].Value.ToString());
                            Ordermanagement_01.Order_View OrderEntry = new Ordermanagement_01.Order_View(Grd_OrderTime.Rows[e.RowIndex].Cells[16].Value.ToString(), "GET_WFA_ORDER_SUB_PROCESS_WISE", "WFA_ORDER_COUNT_SUB_PROCESS_WISE", txt_Fromdate.Text, txt_Todate.Text, User_id, Sub_Process_Id, userroleid);
                            OrderEntry.Show();
                        }
                        else
                        {
                            ...
                            Sub_Process_Id = 0;
                            Ordermanagement_01.Order_View OrderEntry = new Ordermanagement_01.Order_View(Grd_OrderTime.Rows[e.RowIndex].Cells[16].Value.ToString(), "GET_WFA_ORDER", "WFA_ORDER_COUNT", txt_Fromdate.Text, txt_Todate.Text, User_id, Sub_Process_Id, userroleid);
                            OrderEntry.Show();
                        }
                    ...
                    else if (e.ColumnIndex == 13)
                    {
                        if (Pass_Sub_Process_Id != 0)
                        {
                            ...
                            Sub_Process_Id = int.Parse(Grd_OrderTime.Rows[e.RowIndex].Cells[17].Value.ToString());
                            Ordermanagement_01.Order_View OrderEntry = new Ordermanagement_01.Order_View(Grd_OrderTime.Rows[e.RowIndex].Cells[16].Value.ToString(), "GET_Clarification_ORDER_SUB_PROCESS_WISE ", "GET_CLARIFICATION_COUNT_SUB_PROCESS_WISE", txt_Fromdate.Text, txt_Todate.Text, User_id, Sub_Process_Id, userroleid);
                            OrderEntry.Show();
                        }
                        else
                        {
                            ...
                            Sub_Process_Id = 0;
                            Ordermanagement_01.Order_View OrderEntry = new Ordermanagement_01.Order_View(Grd_OrderTime.Rows[e.RowIndex].Cells[16].Value.ToString(), "GET_Clarification_ORDER ", "GET_CLARIFICATION_COUNT", txt_Fromdate.Text, txt_Todate.Text, User_id, Sub_Process_Id, userroleid);
                            OrderEntry.Show();
                        }
                    ...
                    else if (e.ColumnIndex == 14)
                    {
                        if (Pass_Sub_Process_Id != 0)
                        {
                            ...
                            Sub_Process_Id = int.Parse(Grd_OrderTime.Rows[e.RowIndex].Cells[17].Value.ToString());
                            Ordermanagement_01.Order_View OrderEntry = new Ordermanagement_01.Order_View(Grd_OrderTime.Rows[e.RowIndex].Cells[16].Value.ToString(), "GET_Hold_ORDER_SUB_PROCESS_WISE", "GET_HOLDER_ORDER_COUNT_SUB_PROCESS_WISE", txt_Fromdate.Text, txt_Todate.Text, User_id, Sub_Process_Id, userroleid);
                            OrderEntry.Show();
                        }
                        else
                        {
                            ...
                            Sub_Process_Id = 0;
                            Ordermanagement_01.Order_View OrderEntry = new Ordermanagement_01.Order_View(Grd_OrderTime.Rows[e.RowIndex].Cells[16].Value.ToString(), "GET_Hold_ORDER", "GET_HOLDER_ORDER_COUNT", txt_Fromdate.Text, txt_Todate.Text, User_id, Sub_Process_Id, userroleid);
                            OrderEntry.Show();
                        }
                    ...
                    else if (e.ColumnIndex == 15)
                    {
                        if (Pass_Sub_Process_Id != 0)
                        {
                            ...
                            Sub_Process_Id = int.Parse(Grd_OrderTime.Rows[e.RowIndex].Cells[17].Value.ToString());
                            Ordermanagement_01.Order_View OrderEntry = new Ordermanagement_01.Order_View(Grd_OrderTime.Rows[e.RowIndex].Cells[16].Value.ToString(), "GET_Cancelled_ORDER_SUB_PROCESS_WISE", "GET_CANCEELED_COUNT_SUB_PROCESS_WISE", txt_Fromdate.Text, txt_Todate.Text, User_id, Sub_Process_Id, userroleid);
                            OrderEntry.Show();
                        }
                        else
                        {
                            ...
                            Sub_Process_Id = 0;
                            Ordermanagement_01.Order_View OrderEntry = new Ordermanagement_01.Order_View(Grd_OrderTime.Rows[e.RowIndex].Cells[16].Value.ToString(), "GET_Cancelled_ORDER", "GET_CANCEELED_COUNT", txt_Fromdate.Text, txt_Todate.Text, User_id, Sub_Process_Id, userroleid);
                            OrderEntry.Show();
                        }
        ...
        private void Load_Orders_Error_Info_Report()
        {
            ...
            if (dtordererror.Rows.Count > 0)
            {
                ...
                Grd_OrderTime.Columns[10].Name = "Error_From_Status";
                Grd_OrderTime.Columns[10].HeaderText = "QC Status";
                Grd_OrderTime.Columns[10].DataPropertyName = "Error From Status";
                Grd_OrderTime.Columns[10].Width = 150;

                Grd_OrderTime.Columns[11].Name = "Error_Enter_By_Username";
                Grd_OrderTime.Columns[11].HeaderText = "QC Username";
                Grd_OrderTime.Columns[11].DataPropertyName = "Error From Username";
                Grd_OrderTime.Columns[11].Width = 160;

                Grd_OrderTime.Columns[12].Name = "Order_Production_Date";
                Grd_OrderTime.Columns[12].HeaderText = "Production Date";
                Grd_OrderTime.Columns[12].DataPropertyName = "Order Production Date";
                Grd_OrderTime.Columns[12].Width = 120;
