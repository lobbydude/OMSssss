...
namespace Ordermanagement_01.Reports
{
    public partial class Report_Order_Source_view : Form
    {
        ...
        public Report_Order_Source_view(int userid, string userroleid, int clientid,string headertext, int ordersourceid, string order_source, string fromdate, string todate,string clientname,string Userroleid)
        {
            InitializeComponent();
            User_Id = userid;
