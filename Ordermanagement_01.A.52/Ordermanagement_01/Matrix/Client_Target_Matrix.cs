...
namespace Ordermanagement_01.Matrix
{
    public partial class Client_Target_Matrix : Form
    {
        ...
        int check_del, check_order, chk_sub, insertval, check_list;
        ...
        public Client_Target_Matrix(int Userid)
        {
            InitializeComponent();
        ...
        private void btn_Save_Click(object sender, EventArgs e)
        {
            if (ddl_Client.SelectedIndex > 0)
            {
                ...
                if (insertval != 0)
                {
                    MessageBox.Show("Client Target Matrix Record Submitted Successfully");
            ...
            {
                MessageBox.Show("Select the Client name");
            }
