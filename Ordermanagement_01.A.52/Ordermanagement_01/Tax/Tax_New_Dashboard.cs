...
//lbl_External_Tax_Request_Qc_Allocation.Enabled = false;
        ...
        {
            Ordermanagement_01.User_Create Create_User = new User_Create(int.Parse(user_id.ToString()), 2);
            Create_User.Show();
        ...
        private void lbl_Internal_Tax_Request_Order_Allocation_Count_Click(object sender, EventArgs e)
        {
            if (user_role == "1")
            {
                Tax_Order_Allocation tx = new Tax_Order_Allocation(user_id, user_role, "Internal_Tax_Request_Orders_For_Allocate");
                tx.Show();
            }
            else
            {
        ...
        private void lbl_Internal_Tax_Qc_Allocation_Click(object sender, EventArgs e)
        {
            if (user_role == "1")
            {
                Tax_Order_Allocation tx = new Tax_Order_Allocation(user_id, user_role, "Internal_TAx_Request_Qc_For_Order_Allocate");
                tx.Show();
        ...
        private void lbl_External_Tax_Request_Allocation_Count_Click(object sender, EventArgs e)
        {
            ...
            if (user_role == "1")
            {
                Tax_Order_Allocation tx = new Tax_Order_Allocation(user_id, user_role, "External_TaxRequest_Order_For_Allocate");
                tx.Show();
        ...
        private void lbl_External_Tax_Request_Qc_Allocation_Click(object sender, EventArgs e)
        {
            ...
            if (user_role == "1")
            {
                Tax_Order_Allocation tx = new Tax_Order_Allocation(user_id, user_role, "External_Tax_Request_Qc_For_Order_Allocate");
                tx.Show();
            }
            else
            {
        ...
        {
            Tax_Order_Allocation tx = new Tax_Order_Allocation(user_id, user_role, "Internal_Completed");
            tx.Show(); 
        ...
        {
            Tax_Order_Allocation tx = new Tax_Order_Allocation(user_id, user_role, "Internal_Pending");
            tx.Show(); 
        }

        private void lbl_Internal_Tax_Mailway_Count_Click(object sender, EventArgs e)
        {
            Tax_Order_Allocation tx = new Tax_Order_Allocation(user_id, user_role, "Internal_Mailway");
            tx.Show(); 
        }

        private void lbl_InternalTax_Exception_Count_Click(object sender, EventArgs e)
        {
            Tax_Order_Allocation tx = new Tax_Order_Allocation(user_id, user_role, "Internal_Exception");
            tx.Show(); 
        ...
        {
            Tax_Order_Allocation tx = new Tax_Order_Allocation(user_id, user_role, "Internal_Cancelled");
            tx.Show(); 
        }

        private void lbl_External_Tax_Completed_Count_Click(object sender, EventArgs e)
        {
            Tax_Order_Allocation tx = new Tax_Order_Allocation(user_id, user_role, "External_Completed");
            tx.Show(); 
        }

        private void lbl_External_Tax_Pending_Click(object sender, EventArgs e)
        {
            Tax_Order_Allocation tx = new Tax_Order_Allocation(user_id, user_role, "External_Pending");
            tx.Show(); 
        ...
        {
            Tax_Order_Allocation tx = new Tax_Order_Allocation(user_id, user_role, "External_Mailway");
            tx.Show(); 
        ...
        {
            Tax_Order_Allocation tx = new Tax_Order_Allocation(user_id, user_role, "External_Exception");
            tx.Show(); 
        }

        private void lbl_External_Tax_cancelled_Click(object sender, EventArgs e)
        {
            Tax_Order_Allocation tx = new Tax_Order_Allocation(user_id, user_role, "External_Cancelled");
            tx.Show(); 
        }
