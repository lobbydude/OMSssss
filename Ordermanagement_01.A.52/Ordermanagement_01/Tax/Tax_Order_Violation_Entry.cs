...
namespace Ordermanagement_01.Tax
{
    public partial class Tax_Order_Violation_Entry : Form
    {
        ...
        private void Tax_Order_Violation_Entry_Load(object sender, EventArgs e)
        {
            ...
            toolTip1.SetToolTip(txt_Code_ComplianceComments, Demolition_Status_Tooltip.ToString());
            toolTip1.SetToolTip(txt_Code_ComplianceComments, Other_Comments_Tooltip.ToString());
            toolTip1.SetToolTip(txt_Code_ComplianceComments, Scheduled_tax_Tooltip.ToString());
            toolTip1.SetToolTip(txt_Code_ComplianceComments, tax_Sales_date_Tooltip.ToString());
        ...
        private void btn_submit_Click(object sender, EventArgs e)
        {
            ...
            if (Check == 0)
            {
               ...
               // htinsert.Add("@Loan", txt_Loan.Text);
                ...
                htinsert.Add("@Redemption_Amt", lbl_Rem1.Text.ToUpper());
            ...
            else if (Check > 0)
            {
                ...
                htupdate.Add("@Redemption_Amt", lbl_Rem1.Text.ToUpper());
