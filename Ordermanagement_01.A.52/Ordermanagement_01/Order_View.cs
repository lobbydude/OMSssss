...
namespace Ordermanagement_01
{
    public partial class Order_View : Form
    {
       ...
       // InfiniteProgressBar.clsProgress cProbar = new InfiniteProgressBar.clsProgress();
        ...
        public Order_View(string CLIENT_ID, string OPERATION,string OERATION_COUNT, string FROM_DATE, string TO_DATE, int USER_ID,int SUB_PROCESS_D,string User_roleid)
        {
            User_id = USER_ID;
            Client_Id = CLIENT_ID;
            Operation = OPERATION;
