        ...
        protected void Grd_Document_upload_Load()
        {
            ...
            if (dtDocument_Select.Rows.Count > 0)
            {
                ...
                if (User_Role_Id == "1")
                {
                    ...
                    // this is for Supervisior Users
                else if (userid == 246 || userid == 22 || userid == 207 || userid == 89)
                {
                    Grd_Document_upload.Columns[5].Visible = true;


                }
                    // this is for EmployeeRole
                else
                {
            ...
            if (dtselect.Rows.Count > 0)
            {
                ...
                if (dtselect.Rows.Count > 0)
                {
                    ...
                    for (int i = 0; i < dtselect.Rows.Count; i++)
                    {
                        ...
                        Grid_Client_Upload.Rows[i].Cells[10].Value = dtselect.Rows[i]["Document_Path"].ToString();
