...
{
    public partial class Order_Entry_Old : Form
    {
        ...
        public Order_Entry_Old(int Orderid,int User_Id,string User_Roleid)
        {
        ...
        private void Order_Load()
        {
            if (Order_Id != 0)
            {
                ...
                if (userid == 1 || userid == 4 || userid == 99 || userid == 33 || userid == 38 || userid == 204)
                {
                ...
                if (dt_Select_Order_Details.Rows.Count > 0)
                {
                    ...
                    dtp_Effective_date.Text = dt_Select_Order_Details.Rows[0]["Effective_date"].ToString();
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                else if (County_Type != 2)
                                {
                                    ...
                                    //Moving ABC Client Orders Into Re-Search Oreder Allocation Order Queue
      ...
      //  }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (Order_Id == 0)
            {
                ...
                if (dt_Maxid.Rows.Count > 0)
                {
                    ...
                    Order_Uploads_Old Orderuploads = new Order_Uploads_Old("Insert", Orderno, userid, txt_OrderNumber.Text, ddl_ClientName.Text, ddl_SubProcess.Text);
                    Orderuploads.Show();
                }
            }
            else
            {
                ...
                Order_Uploads_Old Orderuploads = new Order_Uploads_Old("Update", Order_Id, userid, txt_OrderNumber.Text, ddl_ClientName.Text, ddl_SubProcess.Text);
                Orderuploads.Show();
            }
        }
        ...
        private void Order_Entry_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            Ordermanagement_01.Employee_Error_Entry_Old Error = new Ordermanagement_01.Employee_Error_Entry_Old(userid, userroleid, "", Order_Id, 3, 1);
            Error.Close();


            Ordermanagement_01.Order_History_List_Old Order_History = new Ordermanagement_01.Order_History_List_Old(userid, Order_Id, txt_OrderNumber.Text, ddl_ClientName.Text, ddl_SubProcess.Text, ddl_State.Text, ddl_County.Text);
            Order_History.Close();
        ...
        private void ddl_ordertype_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (ddl_ordertype.SelectedIndex > 0)
            {
                ...
                {
                    ddl_Abstractor_Search_Type.Text = ddl_ordertype.Text;
                }
        ...
        {
            Ordermanagement_01.Employee_Error_Entry_Old EmployeeError = new Ordermanagement_01.Employee_Error_Entry_Old(userid, userroleid, "", Order_Id, 3, 1);
            EmployeeError.Show();
        ...
        private void btn_Order_Notes_Click(object sender, EventArgs e)
        {
            ...
            Ordermanagement_01.Employee.Employee_Order_Information emp = new Ordermanagement_01.Employee.Employee_Order_Information(userid, State_ID, Order_Id, userroleid);
            emp.Show();
        }
