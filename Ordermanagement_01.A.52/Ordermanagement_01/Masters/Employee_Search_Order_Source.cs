...
namespace Ordermanagement_01.Masters
{
    public partial class Employee_Search_Order_Source : Form
    {
        ...
        string username;
        public Employee_Search_Order_Source(int User_id,string UserName,string User_RoleID)
        {
            InitializeComponent();
            userid = User_id;
        ...
        private void btn_Submit_Click(object sender, EventArgs e)
        {
            if (txt_Order_Source.Text != "")
            {
                ...
                else
                {
                    ...
                    string title = "Insert";
                    MessageBox.Show("Order Source Inserted Successfully",title);
                }
            }
            else
            {
        ...
        private void btn_Delete_Click(object sender, EventArgs e)
        {
            ...
            if (dialog == DialogResult.Yes)
            {
                if (Employee_Source_id != 0)
                {
                    ...
                    MessageBox.Show("Order Source Deleted SUccessfully");
                    clear();
                }
                else
                {
