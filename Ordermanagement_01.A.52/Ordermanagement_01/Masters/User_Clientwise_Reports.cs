...
namespace Ordermanagement_01.Masters
{
    public partial class User_Clientwise_Reports : Form
    {
        ...
        int RowIndex, ColIndex, temp_val, temp_value, recod_Val, chk_value, Client_Id;
        int count;
        int del_val, insert_val, rec_already;
        string User_Name;
        public User_Clientwise_Reports(int Userid,string Username)
        {
            InitializeComponent();
            UserID = Userid;
       ...
       //04-01-2017
        ...
        private void ddl_Username_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (ddl_Username.SelectedIndex > 0)
            {
                ...
                htget_User_Wise_Client.Add("@Trans", "BIND_USERCLIENT");
