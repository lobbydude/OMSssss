        ...
        
        {
            ...
            if (Confirmusername == Username && ConfirmPassword == password)
            {
                    ...
                    if (Application_Login_Id == "1")
                    {
                        ...
                        AdminDashboard mainmenu = new AdminDashboard(USerRoleid, userid, Username);
                    ...
                    else if (Application_Login_Id == "2")
                    {
                        ...
                        Tax.Tax_New_Dashboard taxdashboard = new Tax.Tax_New_Dashboard(USerRoleid, userid, Username);
                        taxdashboard.Show();
                    }
