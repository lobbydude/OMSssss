...
namespace Ordermanagement_01.Vendors
{
    public partial class Vendor_View : Form
    {
        ...
        public Vendor_View(int User_ID)
        {
            InitializeComponent();
            Userid = User_ID;
        ...
        {
            Ordermanagement_01.Vendors.Vendor_Create vendor_create = new Ordermanagement_01.Vendors.Vendor_Create(0,Userid);
            vendor_create.Show();
        }
        ...
        private void grd_Services_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex != -1)
            {
                ...
                {
                    Ordermanagement_01.Vendors.Vendor_Create vendorcreate = new Ordermanagement_01.Vendors.Vendor_Create(int.Parse(grd_Services.Rows[e.RowIndex].Cells[5].Value.ToString()), Userid);
                    vendorcreate.Show();
                     this.Hide();
        ...
        {
            Ordermanagement_01.Vendors.Vendor_Percntage_New vendor_per = new Ordermanagement_01.Vendors.Vendor_Percntage_New(Userid);
            vendor_per.Show();
        }
        ...
        private void vendorCreateToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            ...
            int Vendor_id = 0;
            Ordermanagement_01.Vendors.Vendor_Create vendor_create = new Ordermanagement_01.Vendors.Vendor_Create(Vendor_id, Userid);
        ...
        {
            Ordermanagement_01.Vendors.Vendor_Client_Subclient client_sub = new Ordermanagement_01.Vendors.Vendor_Client_Subclient(Userid);
            client_sub.Show();
        }
        ...
        {
            Vendors.Vendor_Client_Instruction vi = new Vendor_Client_Instruction(Userid);
            vi.Show();
        }
        ...
        {
            Vendors.Vendor_ClientWise_Schema vs = new Vendor_ClientWise_Schema();
            vs.Show();
