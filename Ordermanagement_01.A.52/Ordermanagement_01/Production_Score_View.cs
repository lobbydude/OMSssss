...
{
    public partial class Production_Score_View : Form
    {
        ...
        public Production_Score_View(string OrderTarget, string TimeZone, string Order_ViewType, int Value, int score_user_id, string Tat, string score_user, string pending_header, string date, int USER_ID, string USER_ROLE_ID, string Scoreboard_name)
        {
            InitializeComponent();
        ...
        private void Production_Score_View_Load(object sender, EventArgs e)
        { 
            if (Valuegrd == 4)
            {
            ...
            else if (Valuegrd == 6)
            {
                ...
                Gridview_Employee_USE_HOLD_CLARIFICATION_Production_24_7_Date_Dataview();
                Bind_Grid_View_User_Hold_Total();
            }
        ...
        private void Bind_Grid_View_User_Hold_Total()
        {

            Hashtable htcount = new Hashtable();
            DataTable dtcount = new DataTable();
            htcount.Add("@Trans", "SELECT_BY_TOTAL_LIVE_User_Hold_Calrification_Order_WORK_TYPE_Count");
            dtcount = dataaccess.ExecuteSP("Sp_User_24_7_Production_Report", htcount);
        ...
        private void Gridview_Employee_Production_First_Date_Dataview()
        {
            ...
            dtlivecount = dataaccess.ExecuteSP("Sp_User_24_7_Production_Report", htlivecount);
            dtreworkcount = dataaccess.ExecuteSP("Sp_User_24_7_Production_Report", htreworkcount);
            dtsuperqccount = dataaccess.ExecuteSP("Sp_User_24_7_Production_Report", htsuperqccount);

            dtlivetype = dataaccess.ExecuteSP("Sp_User_24_7_Production_Report", htlivetype);
            dtReworktype = dataaccess.ExecuteSP("Sp_User_24_7_Production_Report", htReworktype);
            dtsuperqctype = dataaccess.ExecuteSP("Sp_User_24_7_Production_Report", htSuperqctype);
        ...
        private void Gridview_Employee_Production_24_7_Date_Dataview()
        {
            ...
            htupd.Add("@Trans", "TOTAL_ORDER_COMPLETED_BY_USER_WISE");
            htupd.Add("@Firstdate", First_Date);
            htupd.Add("@Second_Date", Second_Date);
            htupd.Add("@User_Id", Employee_User_Id);
            dtupd = dataaccess.ExecuteSP("Sp_User_24_7_Employee_Production_Report",htupd);

            dttargetorder = dtupd;

            //ht.Add("@Trans", "GET_TOTAL_ORDER_WITH_BREAK");
            //ht.Add("@User_Id", Employee_User_Id);
            ...
            if (dttargetorder.Rows.Count > 0)
            {
                ...
                lbl_total.Text = dtupd.Rows.Count.ToString();
                if (temptable.Rows.Count > 0)
                {
                    lbl_Name.Text = dtupd.Rows[0]["User_Name"].ToString();
                }
                if (temptable.Rows.Count > 0)
                {
        ...
        private void Gridview_Employee_USE_HOLD_CLARIFICATION_Production_24_7_Date_Dataview()
        {
            Hashtable ht = new Hashtable();
            System.Data.DataTable dt = new System.Data.DataTable();
            ...
            htlivecount.Add("@Trans", "SELECT_BY_TOTAL_LIVE_User_Hold_Calrification_Order_Status_Count");
            htreworkcount.Add("@Trans", "SELECT_BY_TOTAL_REWORK_User_Hold_Calrification_Order_Status_Count");
            htsuperqccount.Add("@Trans", "SELECT_BY_TOTAL_SUPER_QC_User_Hold_Calrification_Order_Status_Count");


            htlivetype.Add("@Trans", "SELECT_BY_TOTAL_LIVE_User_Hold_Calrification_OrderType_Wise_Status_Count");
            htReworktype.Add("@Trans", "SELECT_BY_TOTAL_REWORK_User_Hold_Calrification_OrderType_Wise_Status_Count");
            htSuperqctype.Add("@Trans", "SELECT_BY_TOTAL_SUPER_QC_User_Hold_Calrification_OrderType_Wise_Status_Count");
            ...
            ht.Add("@Trans", "TOTAL_ORDER_USER_HOLD_CALRIFICARION_BY_USER_WISE");
        ...
        private void Grid_Total_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
