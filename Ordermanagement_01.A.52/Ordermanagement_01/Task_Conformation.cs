...
namespace Ordermanagement_01
{
    public partial class Task_Conformation : Form
    {
        ...
        private bool Validate_user()
        {
            ...
            if (Comp_Role_ID == "1" && Comp_Role_ID != "")
            {
              
               
                return true;
            }
            else if (User_Rights_For_Clarification == 94 || User_Rights_For_Clarification == 96 || User_Rights_For_Clarification == 17 || User_Rights_For_Clarification == 77 || User_Rights_For_Clarification == 21 || User_Rights_For_Clarification == 74|| User_Rights_For_Clarification==22)
            {
