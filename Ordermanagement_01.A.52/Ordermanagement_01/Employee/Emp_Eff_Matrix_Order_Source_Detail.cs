...
namespace Ordermanagement_01.Employee
{
    public partial class Emp_Eff_Matrix_Order_Source_Detail : Form
    {
        ...
        int County_ID, Check, count_county,count_SubCLient, Delvalue = 0;
        ...
        int user_ID;
        string User_Name;
        public Emp_Eff_Matrix_Order_Source_Detail(string Username, int User_id)
        {
            InitializeComponent();
            user_ID = User_id;
            User_Name = Username;
        ...
        private bool validation()
        {
            if (ddl_Source_Type.SelectedIndex==0)
            {
               ...
               // ddl_Source_Type.Focus();
                ...
                {
                    MessageBox.Show("Kindly Select any one County name");
                    count_county = 0;
                    return false;
                }
                count_county = 0;
        ...
        private void Bind_Grid_All()
        {
                ...
                if (dt_State_County.Rows.Count > 0)
                {
                    ...
                    {
                        Grd_State_county.Rows.Add();
                        Grd_State_county.Rows[i].Cells[1].Value = dt_State_County.Rows[i]["State"].ToString();
                        Grd_State_county.Rows[i].Cells[3].Value = dt_State_County.Rows[i]["County"].ToString();
                        Grd_State_county.Rows[i].Cells[5].Value = dt_State_County.Rows[i]["Order_Source_Type_ID"].ToString();
                        Grd_State_county.Rows[i].Cells[6].Value = dt_State_County.Rows[i]["Order_Source_Type_Name"].ToString();
                        Grd_State_county.Rows[i].Cells[7].Value = dt_State_County.Rows[i]["EmpEff_OrderSourceType_Id"].ToString();
                    }
                }
                else
                {
        ...
        private void btn_Remove_Click(object sender, EventArgs e)
        {
            ...
            if (dialog == DialogResult.Yes)
            {
                ...
                for (int i = 0; i < Grd_State_county.Rows.Count; i++)
                {
                    bool isc = (bool)Grd_State_county[0, i].FormattedValue;
                    EmpEff_OrderSourceType_Id = int.Parse(Grd_State_county.Rows[i].Cells[7].Value.ToString());
                    if (isc)
                    {
                ...
                {
                    MessageBox.Show("Select County, which will be remove");
                }
                Bind_County_State_Wise();
                Bind_OrderSource_StateCounty();
                //dbc.BindState(ddl_State);
                //dbc.Bind_Order_Source_Type(ddl_Source_Type);
        ...
        private void chk_Select_All_Clients_CheckedChanged(object sender, EventArgs e)
        {
            if (chk_Select_All_Clients.Checked == true)
            {
                ...
                for (int i = 0; i < Grd_EmpEff_Matrix_ClientSub.Rows.Count; i++)
                {
                    ...
                    Grd_EmpEff_Matrix_ClientSub[0, i].Value = true;
                }
            }
            else if (chk_Select_All_Clients.Checked == false)
            {
                ...
                for (int i = 0; i < Grd_EmpEff_Matrix_ClientSub.Rows.Count; i++)
                {
                    ...
                    Grd_EmpEff_Matrix_ClientSub[0, i].Value = false;
                }
            }
            chk_Subclient.Checked = false;
        }
        ...
        private void btn_Remove_ClientSubClient_Click(object sender, EventArgs e)
        {
            ...
            if (dialog == DialogResult.Yes)
            {
                ...
                for (int i = 0; i < Grd_EmpEff_Matrix_ClientSub.Rows.Count; i++)
                {
                    bool isc = (bool)Grd_EmpEff_Matrix_ClientSub[0, i].FormattedValue;
                    EmpEff_ClientSubProcess_Id = int.Parse(Grd_EmpEff_Matrix_ClientSub.Rows[i].Cells[7].Value.ToString());
                    if (isc)
                    {
        ...
        private void Bind_Grid_CLientSubClient_All()
        {
            ...
            if (dtClient_SubClient.Rows.Count > 0)
            {
                ...
                {
                    Grd_EmpEff_Matrix_ClientSub.Rows.Add();
                    Grd_EmpEff_Matrix_ClientSub.Rows[i].Cells[1].Value = dtClient_SubClient.Rows[i]["Order_Source_Type_ID"].ToString();
                    Grd_EmpEff_Matrix_ClientSub.Rows[i].Cells[2].Value = dtClient_SubClient.Rows[i]["Order_Source_Type_Name"].ToString();
                    Grd_EmpEff_Matrix_ClientSub.Rows[i].Cells[4].Value = dtClient_SubClient.Rows[i]["Client_Name"].ToString();
                    Grd_EmpEff_Matrix_ClientSub.Rows[i].Cells[6].Value = dtClient_SubClient.Rows[i]["Sub_ProcessName"].ToString();
                    Grd_EmpEff_Matrix_ClientSub.Rows[i].Cells[7].Value = dtClient_SubClient.Rows[i]["EmpEff_ClientSubProcess_Id"].ToString();
                }
            }
            else
            {
            ...
            if (txt_Search.Text != "" && txt_Search.Text != "Search By State County...")
            {
                ...
                if (temp.Rows.Count > 0)
                {
                    ...
                    for (int i = 0; i < temp.Rows.Count; i++)
                    {
                        Grd_State_county.Rows.Add();
                        Grd_State_county.Rows[i].Cells[0].Value = i + 1;
                        Grd_State_county.Rows[i].Cells[1].Value = temp.Rows[0]["State"].ToString();
                        Grd_State_county.Rows[i].Cells[3].Value = temp.Rows[0]["County"].ToString();
                        Grd_State_county.Rows[i].Cells[5].Value = temp.Rows[0]["Order_Source_Type_ID"].ToString();
                        Grd_State_county.Rows[i].Cells[6].Value = temp.Rows[0]["Order_Source_Type_Name"].ToString();
                        Grd_State_county.Rows[i].Cells[7].Value = temp.Rows[0]["EmpEff_OrderSourceType_Id"].ToString();
                    }
                    lbl_All_Total.Text = temp.Rows.Count.ToString();
                }
                else
        ...
        private void Bind_FilterData_Client_SubClient_Wise()
        {
            if (txt_Search_Client_SubClient.Text != "" && txt_Search_Client_SubClient.Text != "Search By Client SubClient...")
            {
                ...
                dt_Client3.RowFilter = "Client_Name like '%" + txt_Search_Client_SubClient.Text.ToString() + "%' or Sub_ProcessName like '%" + txt_Search_Client_SubClient.Text.ToString() + "%' or Order_Source_Type_Name like '%" + txt_Search_Client_SubClient.Text.ToString() + "%'";
                DataTable temp = new DataTable();
        ...
        private void BindFilterData_OrderSourceType_Wise()
        {
            if (txt_Search_Client_SubClient.Text != "" && txt_Search_Client_SubClient.Text != "Search By Client SubClient...")
            {
                ...
                dt_Client2.RowFilter = "Client_Name like '%" + txt_Search_Client_SubClient.Text.ToString() + "%' or Sub_ProcessName like '%" + txt_Search_Client_SubClient.Text.ToString() + "%' or Order_Source_Type_Name like '%" + txt_Search_Client_SubClient.Text.ToString() + "%'";
                DataTable temp = new DataTable();
        ...
        private void BindFilterData_Client_SubClient()
        {
            if (txt_Search_Client_SubClient.Text != "" && txt_Search_Client_SubClient.Text != "Search By Client SubClient...")
            {
                ...
                dt_Client1.RowFilter = "Client_Name like '%" + txt_Search_Client_SubClient.Text.ToString() + "%' or Sub_ProcessName like '%" + txt_Search_Client_SubClient.Text.ToString() + "%' or Order_Source_Type_Name like '%" + txt_Search_Client_SubClient.Text.ToString() + "%'";
                DataTable temp = new DataTable();
