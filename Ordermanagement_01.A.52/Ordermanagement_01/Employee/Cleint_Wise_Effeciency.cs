...
namespace Ordermanagement_01.Employee
{
    public partial class Cleint_Wise_Effeciency : Form
    {
        ...
        public Cleint_Wise_Effeciency(string Username, int User_id)
        {
            InitializeComponent();
            user_ID = User_id;
            User_Name = Username;
        ...
        private void Grid_Bind_ClientWise_CatSal_Bracket_TAT()
        {
            ...
            if (dtsel.Rows.Count > 0)
            {
                ...
                for (int i = 0; i < dtsel.Rows.Count; i++)
                {
                    ...
                    {
                        Grd_Client_Cat_Sal_Bracket_TAT.Rows[i].Cells[1].Value = 0;
                    }
                    else
                    {
                        Grd_Client_Cat_Sal_Bracket_TAT.Rows[i].Cells[1].Value = int.Parse(dtsel.Rows[i]["Client_Id"].ToString());
                    }

                    if (dtsel.Rows[i]["Order_Status_ID"].ToString() == "")
                    {
                        Grd_Client_Cat_Sal_Bracket_TAT.Rows[i].Cells[3].Value = 0;
                    }
                    else
                    {
                        Grd_Client_Cat_Sal_Bracket_TAT.Rows[i].Cells[3].Value = int.Parse(dtsel.Rows[i]["Order_Status_ID"].ToString());
                    }
                    //
                    if (dtsel.Rows[i]["OrderType_ABS_Id"].ToString() == "")
                    {
                        Grd_Client_Cat_Sal_Bracket_TAT.Rows[i].Cells[5].Value = 0;
                    }
                    else
                    {
                        Grd_Client_Cat_Sal_Bracket_TAT.Rows[i].Cells[5].Value = int.Parse(dtsel.Rows[i]["OrderType_ABS_Id"].ToString());
                    }
                    //
                    if (dtsel.Rows[i]["Order_Source_Type_ID"].ToString() == "")
                    {
                        Grd_Client_Cat_Sal_Bracket_TAT.Rows[i].Cells[7].Value = 0;
                    }
                    else
                    {
                        Grd_Client_Cat_Sal_Bracket_TAT.Rows[i].Cells[7].Value = int.Parse(dtsel.Rows[i]["Order_Source_Type_ID"].ToString());
                    }
                    //
        ...
        private void Save_Tabpage1()
        {
            ...
            {
              if (Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[1].Value !="0"  && Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[3].Value != "0"  && Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[5].Value != "0"  && Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[7].Value != "0")
              {
                   ...
                   if (Column1.HeaderText == "1.1")
                   {
                       ...
                       htsearch.Add("@Client_Id", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[1].Value.ToString());
                       htsearch.Add("@Order_Status_ID", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[3].Value.ToString());
                       htsearch.Add("@OrderType_ABS_Id", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[5].Value.ToString());
                       htsearch.Add("@Order_Source_Type_ID", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[7].Value.ToString());
                       ...
                       if (dtsearch.Rows.Count > 0)
                       {
                           ...
                           ht_Update6.Add("@Client_Id", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[1].Value.ToString());
                           ht_Update6.Add("@Order_Status_ID", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[3].Value.ToString());
                           ht_Update6.Add("@OrderType_ABS_Id", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[5].Value.ToString());
                           ht_Update6.Add("@Order_Source_Type_ID", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[7].Value.ToString());

                           if (Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[9].Value != null)
                           {
                               ht_Update6.Add("@Allocated_Time", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[9].Value.ToString());
                           }
                           else
                           {
                       ...
                       else
                       {
                           if (Emp_Client_CatSakBracket_TAT_ID == 0)
                           {
                               ...
                               ht_Insert6.Add("@Client_Id", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[1].Value.ToString());
                               ht_Insert6.Add("@Order_Status_ID", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[3].Value.ToString());
                               ht_Insert6.Add("@OrderType_ABS_Id", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[5].Value.ToString());
                               ht_Insert6.Add("@Order_Source_Type_ID", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[7].Value.ToString());
                               ht_Insert6.Add("@Category_ID", 1);

                               if (Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[9].Value != null)
                               {
                                   ht_Insert6.Add("@Allocated_Time", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[9].Value.ToString());
                               }
                               else
                               {
                   ...
                   if (Column8.HeaderText == "1.2")
                   {
                            ...
                            if (dtsearch.Rows.Count > 0)
                            {
                                ...
                                if (Emp_Client_CatSakBracket_TAT_ID != 0)
                                {
                                    ...
                                    ht_Update8.Add("@Client_Id", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[1].Value.ToString());
                                    ht_Update8.Add("@Order_Status_ID", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[3].Value.ToString());
                                    ht_Update8.Add("@OrderType_ABS_Id", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[5].Value.ToString());
                                    ht_Update8.Add("@Order_Source_Type_ID", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[7].Value.ToString());
                                    ht_Update8.Add("@Category_ID", 2);

                                    if (Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[10].Value != null)
                                    {
                                        ht_Update8.Add("@Allocated_Time", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[10].Value.ToString());
                                    }
                                    else
                                    {
                            ...
                            else
                            {
                                if (Emp_Client_CatSakBracket_TAT_ID == 0)
                                {
                                    ...
                                    ht_Insert8.Add("@Client_Id", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[1].Value.ToString());
                                    ht_Insert8.Add("@Order_Status_ID", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[3].Value.ToString());
                                    ht_Insert8.Add("@OrderType_ABS_Id", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[5].Value.ToString());
                                    ht_Insert8.Add("@Order_Source_Type_ID", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[7].Value.ToString());
                                    ht_Insert8.Add("@Category_ID", 2);

                                    if (Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[10].Value != null)
                                    {
                                        ht_Insert8.Add("@Allocated_Time", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[10].Value.ToString());
                                    }
                                    else
                                    {
                        ...
                        if (Column9.HeaderText == "1.3")
                        {
                            ...
                            if (dtsearch.Rows.Count > 0)
                            {
                                ...
                                if (Emp_Client_CatSakBracket_TAT_ID != 0)
                                {
                                    ...
                                    ht_Update9.Add("@Client_Id", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[1].Value.ToString());
                                    ht_Update9.Add("@Order_Status_ID", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[3].Value.ToString());
                                    ht_Update9.Add("@OrderType_ABS_Id", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[5].Value.ToString());
                                    ht_Update9.Add("@Order_Source_Type_ID", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[7].Value.ToString());
                                    ht_Update9.Add("@Category_ID", 3);
                                    if (Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[11].Value != null)
                                    {
                                        ht_Update9.Add("@Allocated_Time", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[11].Value.ToString());
                                    }
                                    else
                                    {
                            ...
                            else
                            {
                                ...
                                if (Emp_Client_CatSakBracket_TAT_ID == 0)
                                {
                                    ...
                                    ht_Insert9.Add("@Client_Id", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[1].Value.ToString());
                                    ht_Insert9.Add("@Order_Status_ID", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[3].Value.ToString());
                                    ht_Insert9.Add("@OrderType_ABS_Id", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[5].Value.ToString());
                                    ht_Insert9.Add("@Order_Source_Type_ID", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[7].Value.ToString());
                                    ht_Insert9.Add("@Category_ID", 3);
                                    if (Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[11].Value != null)
                                    {
                                        ht_Insert9.Add("@Allocated_Time", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[11].Value.ToString());
                                    }
                                    else
                                    {
                        ...
                        if (Column10.HeaderText == "1.4")
                        {
                            ...
                            if (dtsearch.Rows.Count > 0)
                            {
                                ...
                                if (Emp_Client_CatSakBracket_TAT_ID != 0)
                                {
                                    ...
                                    ht_Update10.Add("@Client_Id", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[1].Value.ToString());
                                    ht_Update10.Add("@Order_Status_ID", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[3].Value.ToString());
                                    ht_Update10.Add("@OrderType_ABS_Id", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[5].Value.ToString());
                                    ht_Update10.Add("@Order_Source_Type_ID", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[7].Value.ToString());
                                    ht_Update10.Add("@Category_ID", 4);
                                    if (Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[12].Value != null)
                                    {
                                        ht_Update10.Add("@Allocated_Time", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[12].Value.ToString());
                                    }
                                    else
                                    {
                            ...
                            else
                            {
                                if (Emp_Client_CatSakBracket_TAT_ID == 0)
                                {
                                    ...
                                    ht_Insert10.Add("@Client_Id", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[1].Value.ToString());
                                    ht_Insert10.Add("@Order_Status_ID", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[3].Value.ToString());
                                    ht_Insert10.Add("@OrderType_ABS_Id", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[5].Value.ToString());
                                    ht_Insert10.Add("@Order_Source_Type_ID", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[7].Value.ToString());
                                    ht_Insert10.Add("@Category_ID", 4);

                                    if (Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[12].Value != null)
                                    {
                                        ht_Insert10.Add("@Allocated_Time", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[12].Value.ToString());
                                    }
                                    else
                                    {
                        ...
                        if (Column11.HeaderText == "1.5")
                        {
                            ...
                            if (dtsearch.Rows.Count > 0)
                            {
                                ...
                                if (Emp_Client_CatSakBracket_TAT_ID != 0)
                                {
                                    ...
                                    ht_Update11.Add("@Client_Id", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[1].Value.ToString());
                                    ht_Update11.Add("@Order_Status_ID", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[3].Value.ToString());
                                    ht_Update11.Add("@OrderType_ABS_Id", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[5].Value.ToString());
                                    ht_Update11.Add("@Order_Source_Type_ID", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[7].Value.ToString());
                                    ht_Update11.Add("@Category_ID", 5);
                                    if (Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[13].Value != null)
                                    {
                                        ht_Update11.Add("@Allocated_Time", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[13].Value.ToString());
                                    }
                                    else
                                    {
                            ...
                            else
                            {
                                if (Emp_Client_CatSakBracket_TAT_ID == 0)
                                {
                                    ...
                                    ht_Insert11.Add("@Client_Id", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[1].Value.ToString());
                                    ht_Insert11.Add("@Order_Status_ID", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[3].Value.ToString());
                                    ht_Insert11.Add("@OrderType_ABS_Id", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[5].Value.ToString());
                                    ht_Insert11.Add("@Order_Source_Type_ID", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[7].Value.ToString());
                                    ht_Insert11.Add("@Category_ID", 5);

                                    if (Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[13].Value != null)
                                    {
                                        ht_Insert11.Add("@Allocated_Time", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[13].Value.ToString());
                                    }
                                    else
                                    {
                        ...
                        if (Column12.HeaderText == "1.6")
                        {
                            ...
                            if (dtsearch.Rows.Count > 0)
                            {
                                ...
                                if (Emp_Client_CatSakBracket_TAT_ID != 0)
                                {
                                    ...
                                    ht_Update12.Add("@Client_Id", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[1].Value.ToString());
                                    ht_Update12.Add("@Order_Status_ID", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[3].Value.ToString());
                                    ht_Update12.Add("@OrderType_ABS_Id", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[5].Value.ToString());
                                    ht_Update12.Add("@Order_Source_Type_ID", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[7].Value.ToString());
                                    ht_Update12.Add("@Category_ID", 6);
                                    if (Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[14].Value != null)
                                    {
                                        ht_Update12.Add("@Allocated_Time", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[14].Value.ToString());
                                    }
                                    else
                                    {
                            ...
                            else
                            {
                                ...
                                if (Emp_Client_CatSakBracket_TAT_ID == 0)
                                {
                                    ...
                                    ht_Insert12.Add("@Client_Id", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[1].Value.ToString());
                                    ht_Insert12.Add("@Order_Status_ID", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[3].Value.ToString());
                                    ht_Insert12.Add("@OrderType_ABS_Id", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[5].Value.ToString());
                                    ht_Insert12.Add("@Order_Source_Type_ID", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[7].Value.ToString());
                                    ht_Insert12.Add("@Category_ID", 6);

                                    if (Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[14].Value != null)
                                    {
                                        ht_Insert12.Add("@Allocated_Time", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[14].Value.ToString());
                                    }
                                    else
                                    {
                        ...
                        if (Column13.HeaderText == "2.1")
                        {
                            ...
                            if (dtsearch.Rows.Count > 0)
                            {
                                ...
                                if (Emp_Client_CatSakBracket_TAT_ID != 0)
                                {
                                    ...
                                    ht_Update13.Add("@Client_Id", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[1].Value.ToString());
                                    ht_Update13.Add("@Order_Status_ID", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[3].Value.ToString());
                                    ht_Update13.Add("@OrderType_ABS_Id", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[5].Value.ToString());
                                    ht_Update13.Add("@Order_Source_Type_ID", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[7].Value.ToString());
                                    ht_Update13.Add("@Category_ID", 7);
                                    if (Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[15].Value != null)
                                    {
                                        ht_Update13.Add("@Allocated_Time", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[15].Value.ToString());
                                    }
                                    else
                                    {
                            ...
                            else
                            {
                                ...
                                if (Emp_Client_CatSakBracket_TAT_ID == 0)
                                {
                                    ...
                                    ht_Insert13.Add("@Client_Id", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[1].Value.ToString());
                                    ht_Insert13.Add("@Order_Status_ID", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[3].Value.ToString());
                                    ht_Insert13.Add("@OrderType_ABS_Id", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[5].Value.ToString());
                                    ht_Insert13.Add("@Order_Source_Type_ID", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[7].Value.ToString());
                                    ht_Insert13.Add("@Category_ID", 7);

                                    if (Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[15].Value != null)
                                    {
                                        ht_Insert13.Add("@Allocated_Time", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[15].Value.ToString());
                                    }
                                    else
                                    {
                        ...
                        if (Column14.HeaderText == "2.2")
                        {
                            ...
                            if (dtsearch.Rows.Count > 0)
                            {
                                ...
                                if (Emp_Client_CatSakBracket_TAT_ID != 0)
                                {
                                    ...
                                    ht_Update14.Add("@Client_Id", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[1].Value.ToString());
                                    ht_Update14.Add("@Order_Status_ID", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[3].Value.ToString());
                                    ht_Update14.Add("@OrderType_ABS_Id", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[5].Value.ToString());
                                    ht_Update14.Add("@Order_Source_Type_ID", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[7].Value.ToString());
                                    ht_Update14.Add("@Category_ID", 8);
                                    if (Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[16].Value != null)
                                    {
                                        ht_Update14.Add("@Allocated_Time", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[16].Value.ToString());
                                    }
                                    else
                                    {
                            ...
                            else
                            {
                                ...
                                if (Emp_Client_CatSakBracket_TAT_ID == 0)
                                {
                                    ...
                                    ht_Insert14.Add("@Client_Id", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[1].Value.ToString());
                                    ht_Insert14.Add("@Order_Status_ID", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[3].Value.ToString());
                                    ht_Insert14.Add("@OrderType_ABS_Id", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[5].Value.ToString());
                                    ht_Insert14.Add("@Order_Source_Type_ID", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[7].Value.ToString());
                                    ht_Insert14.Add("@Category_ID", 8);
                                    if (Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[16].Value != null)
                                    {
                                        ht_Insert14.Add("@Allocated_Time", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[16].Value.ToString());
                                    }
                                    else
                                    {
                        ...
                        if (Column15.HeaderText == "2.3")
                        {
                            ...
                            if (dtsearch.Rows.Count > 0)
                            {
                                ...
                                if (Emp_Client_CatSakBracket_TAT_ID != 0)
                                {
                                    ...
                                    ht_Update15.Add("@Client_Id", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[1].Value.ToString());
                                    ht_Update15.Add("@Order_Status_ID", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[3].Value.ToString());
                                    ht_Update15.Add("@OrderType_ABS_Id", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[5].Value.ToString());
                                    ht_Update15.Add("@Order_Source_Type_ID", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[7].Value.ToString());
                                    ht_Update15.Add("@Category_ID", 9);

                                    if (Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[17].Value != null)
                                    {
                                        ht_Update15.Add("@Allocated_Time", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[17].Value.ToString());
                                    }
                                    else
                                    {
                            ...
                            else
                            {
                                ...
                                if (Emp_Client_CatSakBracket_TAT_ID == 0)
                                {
                                    ...
                                    ht_Insert15.Add("@Client_Id", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[1].Value.ToString());
                                    ht_Insert15.Add("@Order_Status_ID", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[3].Value.ToString());
                                    ht_Insert15.Add("@OrderType_ABS_Id", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[5].Value.ToString());
                                    ht_Insert15.Add("@Order_Source_Type_ID", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[7].Value.ToString());
                                    ht_Insert15.Add("@Category_ID", 9);
                                    if (Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[17].Value != null)
                                    {
                                        ht_Insert15.Add("@Allocated_Time", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[17].Value.ToString());
                                    }
                                    else
                                    {
                        ...
                        if (Column21.HeaderText == "2.4")
                        {
                            ...
                            if (dtsearch.Rows.Count > 0)
                            {
                                ...
                                if (Emp_Client_CatSakBracket_TAT_ID != 0)
                                {
                                    ...
                                    ht_Update16.Add("@Client_Id", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[1].Value.ToString());
                                    ht_Update16.Add("@Order_Status_ID", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[3].Value.ToString());
                                    ht_Update16.Add("@OrderType_ABS_Id", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[5].Value.ToString());
                                    ht_Update16.Add("@Order_Source_Type_ID", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[7].Value.ToString());
                                    ht_Update16.Add("@Category_ID", 10);

                                    if (Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[18].Value != null)
                                    {
                                        ht_Update16.Add("@Allocated_Time", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[18].Value.ToString());
                                    }
                                    else
                                    {
                            ...
                            else
                            {
                                ...
                                if (Emp_Client_CatSakBracket_TAT_ID == 0)
                                {
                                    ...
                                    ht_Insert16.Add("@Client_Id", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[1].Value.ToString());
                                    ht_Insert16.Add("@Order_Status_ID", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[3].Value.ToString());
                                    ht_Insert16.Add("@OrderType_ABS_Id", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[5].Value.ToString());
                                    ht_Insert16.Add("@Order_Source_Type_ID", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[7].Value.ToString());
                                    ht_Insert16.Add("@Category_ID", 10);
                                    if (Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[18].Value != null)
                                    {
                                        ht_Insert16.Add("@Allocated_Time", Grd_Client_Cat_Sal_Bracket_TAT.Rows[j].Cells[18].Value.ToString());
                                    }
                                    else
                                    {
            ...
            if (e.RowIndex != -1)
            {
                if (e.ColumnIndex == 19)
                {
                    ...
                    if (dialog == DialogResult.Yes)
                    {
                        ...
                        ht_Delete.Add("@Client_Id", Grd_Client_Cat_Sal_Bracket_TAT.Rows[e.RowIndex].Cells[1].Value.ToString());
                        ht_Delete.Add("@Order_Status_ID", Grd_Client_Cat_Sal_Bracket_TAT.Rows[e.RowIndex].Cells[3].Value.ToString());
                        ht_Delete.Add("@OrderType_ABS_Id", Grd_Client_Cat_Sal_Bracket_TAT.Rows[e.RowIndex].Cells[5].Value.ToString());
                        ht_Delete.Add("@Order_Source_Type_ID", Grd_Client_Cat_Sal_Bracket_TAT.Rows[e.RowIndex].Cells[7].Value.ToString());
        ...
        private void Grid_Bind_ClientWise()
        {
            ...
            if (dtsel.Rows.Count > 0)
            {
                ...
                for (int i = 0; i < dtsel.Rows.Count; i++)
                {
                    ...
                    grd_Client_Wise_Import.Rows[i].Cells[15].Value = dtsel.Rows[i]["2.1"].ToString();
                    grd_Client_Wise_Import.Rows[i].Cells[16].Value = dtsel.Rows[i]["2.2"].ToString();
                    grd_Client_Wise_Import.Rows[i].Cells[17].Value = dtsel.Rows[i]["2.3"].ToString();
                    grd_Client_Wise_Import.Rows[i].Cells[18].Value = dtsel.Rows[i]["2.4"].ToString();
                    grd_Client_Wise_Import.Rows[i].Cells[21].Value = " DELETE";
                }
            }
        }
            ...
            if (txtFileName != string.Empty)
            {
                try
                {
                    ...
                    for (i = 0; i < data.Rows.Count; i++)
                    {
                        ...
                        //Client_ID Not Exist // Status is False
                        //Hashtable ht_newrows = new Hashtable();
                        //DataTable dt_newrows = new DataTable();
                        //ht_newrows.Add("@Trans", "GET_CLIENT_ID");
                        //ht_newrows.Add("@Client_Name", Client_Name);
                        //dt_newrows = dataaccess.ExecuteSP("SP_Eff_Client_Order_Task_Source_Type_Order_Type_Tat", ht_newrows);
                        //if (dt_newrows.Rows.Count == 0 && Client_Name!="")
                        //{
                           
                        //   // value = 1;
                        //   // grd_Client_Wise_Import.Rows[i].DefaultCellStyle.BackColor = Color;
                        //    MessageBox.Show(" * " + Client_Name + "*" + " Client Not Available / Upload Existed Client Record");
                        //   // break;
                        ...
                        //{
                            //Client_Name = data.Rows[i]["Client_Name"].ToString();
                            //Order_Status = data.Rows[i]["Order_Status"].ToString();
                            //Order_Type_Abb = data.Rows[i]["Order_Type_Abb"].ToString();
                            //Order_Source_Type_Name = data.Rows[i]["Order_Source_Type_Name"].ToString();
                            ...
                            grd_Client_Wise_Import.Rows[i].Cells[15].Value = data.Rows[i]["2_1"].ToString();
                            grd_Client_Wise_Import.Rows[i].Cells[16].Value = data.Rows[i]["2_2"].ToString();
                            grd_Client_Wise_Import.Rows[i].Cells[17].Value = data.Rows[i]["2_3"].ToString();
                            grd_Client_Wise_Import.Rows[i].Cells[18].Value = data.Rows[i]["2_4"].ToString();

                           // grd_Client_Wise_Import.Rows[i].Cells[20].Value = " DELETE";
                            ...
                            htabsid.Add("@Client_Name", Client_Name);
                            ...
                            //{
                            //    grd_Client_Wise_Import.Rows[i].DefaultCellStyle.BackColor = Color.Yellow;
                            //    MessageBox.Show("Record already existed");
                            //   // newrow = 0;
                            //}
                            //else if (newrow == 0)
                            //{
        ...
        private void btn_Import_Client_Wise_Click(object sender, EventArgs e)
        {
            ...
            //htstate.Add("@Trans", "SELECT_ORDER_STATUS_ID");
            //htstate.Add("@Order_Status", Order_Status);
            //dtstate = dataaccess.ExecuteSP("SP_Eff_Client_Order_Task_Source_Type_Order_Type_Tat", htstate);
            //if (dtstate.Rows.Count != 0)
            //{
            //    Order_Status_ID = int.Parse(dtstate.Rows[0]["Order_Status_ID"].ToString());
            //}
            ...
            //ht_chk.Add("@Trans", "CHECK");
            //ht_chk.Add("@Category_ID", 1);
            //ht_chk.Add("@Client_Id", Client_Id);
            //ht_chk.Add("@Order_Status_ID", Order_Status_ID);
            //ht_chk.Add("@OrderType_ABS_Id", OrderType_ABS_Id);
            //ht_chk.Add("@Order_Source_Type_ID", Order_Source_Type_ID);
            //dt_chk = dataaccess.ExecuteSP("SP_Eff_Client_Order_Task_Source_Type_Order_Type_Tat", ht_chk);
            //checkvalue = int.Parse(dt_chk.Rows[0]["Count"].ToString());
            int j;
            ...
            {
                //if (grd_Client_Wise_Import.Rows[j].DefaultCellStyle.BackColor == Color.White)
                //{
                    if (grd_Client_Wise_Import.Rows[j].Cells[1].Value != null && grd_Client_Wise_Import.Rows[j].Cells[2].Value != "0"  && grd_Client_Wise_Import.Rows[j].Cells[3].Value != null && grd_Client_Wise_Import.Rows[j].Cells[4].Value != "0" && grd_Client_Wise_Import.Rows[j].Cells[5].Value != null && grd_Client_Wise_Import.Rows[j].Cells[6].Value != "0" && grd_Client_Wise_Import.Rows[j].Cells[7].Value != null && grd_Client_Wise_Import.Rows[j].Cells[8].Value != "0")
                    {
                        ...
                        if (Column13.HeaderText == "2.1")
                        {
                            ...
                            if (dtsearch.Rows.Count > 0)
                            {
                                ...
                                ht_Update13.Add("@Category_ID", 7);
                                if (grd_Client_Wise_Import.Rows[j].Cells[15].Value != null)
                                {
                                    ht_Update13.Add("@Allocated_Time", grd_Client_Wise_Import.Rows[j].Cells[15].Value.ToString());
                                }
                                else
                                {
                                    ht_Update13.Add("@Allocated_Time", 0);
                            ...
                            else
                            {
                                ...
                                if (grd_Client_Wise_Import.Rows[j].Cells[15].Value != null)
                                {
                                    ht_Insert13.Add("@Allocated_Time", grd_Client_Wise_Import.Rows[j].Cells[15].Value.ToString());
                                }
                                else
                                {
                                    ht_Insert13.Add("@Allocated_Time", 0);
                        ...
                        if (Column14.HeaderText == "2.2")
                        {
                            ...
                            if (dtsearch.Rows.Count > 0)
                            {
                                ...
                                ht_Update14.Add("@Category_ID", 8);
                                if (grd_Client_Wise_Import.Rows[j].Cells[16].Value != null)
                                {
                                    ht_Update14.Add("@Allocated_Time", grd_Client_Wise_Import.Rows[j].Cells[16].Value.ToString());
                                }
                                else
                                {
                                    ht_Update14.Add("@Allocated_Time", 0);
                            ...
                            else
                            {
                                ...
                                if (grd_Client_Wise_Import.Rows[j].Cells[16].Value != null)
                                {
                                    ht_Insert14.Add("@Allocated_Time", grd_Client_Wise_Import.Rows[j].Cells[16].Value.ToString());
                                }
                                else
                                {
                                    ht_Insert14.Add("@Allocated_Time", 0);
                        ...
                        if (Column15.HeaderText == "2.3")
                        {
                            ...
                            if (dtsearch.Rows.Count > 0)
                            {
                                ...
                                if (grd_Client_Wise_Import.Rows[j].Cells[17].Value != null)
                                {
                                    ht_Update15.Add("@Allocated_Time", grd_Client_Wise_Import.Rows[j].Cells[17].Value.ToString());
                                }
                                else
                                {
                                    ht_Update15.Add("@Allocated_Time", 0);
                            ...
                            else
                            {
                                ...
                                if (grd_Client_Wise_Import.Rows[j].Cells[17].Value != null)
                                {
                                    ht_Insert15.Add("@Allocated_Time", grd_Client_Wise_Import.Rows[j].Cells[17].Value.ToString());
                                }
                                else
                                {
                                    ht_Insert15.Add("@Allocated_Time", 0);
                ...
                //else
                //{
                //    MessageBox.Show("Client Already existed");
                //    break;
                //}
                //if (checkvalue == 0)
                //{
         ...
         //   grd_Client_Wise_Import.Rows.Clear();
            ...
            //MessageBox.Show("*" + j + " * " + " Number of Records Imported Successfully");
            //}
        }
        ...
        private void Grid_Bind_Client_Name()
        {
            ...
            if (dt_clientName.Rows.Count > 0)
            {
                ...
                for (int i = 0; i < dt_clientName.Rows.Count; i++)
                {
                    ...
                    grd_Copy_Clients.Rows[i].Cells[1].Value = int.Parse(dt_clientName.Rows[i]["Client_Id"].ToString());
                    grd_Copy_Clients.Rows[i].Cells[2].Value = dt_clientName.Rows[i]["Client_Name"].ToString();
                }
            }
        }
           ...
           // ht_sel.Add("@Trans", "SELECT");
            ...
            if (dt_sel.Rows.Count > 0)
            {
                ...
                for (int i = 0; i < dt_sel.Rows.Count; i++)
                {
                    ...
                    {
                        grid_Client.Rows[i].Cells[1].Value = 0;
                    }
                    else
                    {
                        grid_Client.Rows[i].Cells[1].Value = int.Parse(dt_sel.Rows[i]["Client_Id"].ToString());
                    }
                    grid_Client.Rows[i].Cells[2].Value = dt_sel.Rows[i]["Client_Name"].ToString();
        ...
        private bool Validate_Copy()
        {
            ...
            for (int i = 0; i < grd_Copy_Clients.Rows.Count; i++)
            {
                ...
                bool C_list = (bool)grd_Copy_Clients[0, i].FormattedValue;
                if (C_list == true)
                {
        ...
        private void Clear()
        {
            ...
            {
                bool ischecked = (bool)grid_Client[0, j].FormattedValue;
                if (ischecked == true)
                {
                    grid_Client[0, j].Value = false;
                }
            }

            for (int j = 0; j < grd_Copy_Clients.Rows.Count; j++)
            {
                bool ischecked = (bool)grd_Copy_Clients[0, j].FormattedValue;
                if (ischecked == true)
                {
                    grd_Copy_Clients[0, j].Value = false;
                }
            }
        ...
        private void btn_Copy_Clients_Click(object sender, EventArgs e)
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                if (Validate_Copy() != false)
                {
                    ...
                    for (int i = 0; i < grd_Copy_Clients.Rows.Count; i++)
                    {
                        bool Check = (bool)grd_Copy_Clients[0,i].FormattedValue;
                        Copy_Client_Id = int.Parse(grd_Copy_Clients.Rows[i].Cells[1].Value.ToString());
                        ...
                        if (Check == true)
                        {
                            ...
                            for (int j = 0; j < grid_Client.Rows.Count; j++)
                            {
                                bool Client_list = (bool)grid_Client[0,j].FormattedValue;
                                Client_Id = int.Parse(grid_Client.Rows[j].Cells[1].Value.ToString());
                                // Category_ID = i + 1;
                                if (Client_list == true)
                                {
        ...
        private void chk_All_Copy_To_Clients_CheckedChanged(object sender, EventArgs e)
        {
            if (chk_All_Copy_To_Clients.Checked==true)
            {
                for (int i = 0; i < grd_Copy_Clients.Rows.Count; i++)
                {
                    grd_Copy_Clients[0, i].Value = true;
                }
            }
            ...
            else
            {
                if (chk_All_Copy_To_Clients.Checked == false)
                {
                    for (int i = 0; i < grd_Copy_Clients.Rows.Count; i++)
                    {
                        grd_Copy_Clients[0, i].Value = false;
                    }
                }
            }
        }
        ...
        private void Grid_Export_Data()
        {
            ...
            {
                if (column.Index != 1 && column.Index != 3 && column.Index != 5 && column.Index != 7 && column.Index != 18 && column.Index != 19 && column.Index != 20)
                {
            ...
            foreach (DataGridViewRow row in grd_Client_Wise_Import.Rows)
            {
                ...
                {
                    if (cell.ColumnIndex != 1 && cell.ColumnIndex != 3 && cell.ColumnIndex != 5 && cell.ColumnIndex != 7 && cell.ColumnIndex != 18 && cell.ColumnIndex != 19 && cell.ColumnIndex != 20)
                    {
        ...
        private void Bind_Filter_Data_By_Search()
        {
           ...
           if (dt_Search.Rows.Count > 0)
           {
               ...
               for (int i = 0; i < dt_Search.Rows.Count; i++)
               {
                   ...
                   {
                       Grd_Client_Cat_Sal_Bracket_TAT.Rows[i].Cells[1].Value = int.Parse(dt_Search.Rows[i]["Client_Id"].ToString());
                   }
                   ...
                   {
                       Grd_Client_Cat_Sal_Bracket_TAT.Rows[i].Cells[3].Value = int.Parse(dt_Search.Rows[i]["Order_Status_ID"].ToString());
                   }
                   //
                   ...
                   {
                       Grd_Client_Cat_Sal_Bracket_TAT.Rows[i].Cells[5].Value = int.Parse(dt_Search.Rows[i]["OrderType_ABS_Id"].ToString());
                   }
                   //
                   ...
                   {
                       Grd_Client_Cat_Sal_Bracket_TAT.Rows[i].Cells[7].Value = int.Parse(dt_Search.Rows[i]["Order_Source_Type_ID"].ToString());
                   }
                   //
                   Grd_Client_Cat_Sal_Bracket_TAT.Rows[i].Cells[9].Value =  dt_Search.Rows[i]["1.1"].ToString();
                   Grd_Client_Cat_Sal_Bracket_TAT.Rows[i].Cells[10].Value = dt_Search.Rows[i]["1.2"].ToString();
                   Grd_Client_Cat_Sal_Bracket_TAT.Rows[i].Cells[11].Value = dt_Search.Rows[i]["1.3"].ToString();
                   ...
                   Grd_Client_Cat_Sal_Bracket_TAT.Rows[i].Cells[15].Value = dt_Search.Rows[i]["2.1"].ToString();
                   Grd_Client_Cat_Sal_Bracket_TAT.Rows[i].Cells[16].Value = dt_Search.Rows[i]["2.2"].ToString();
                   Grd_Client_Cat_Sal_Bracket_TAT.Rows[i].Cells[17].Value = dt_Search.Rows[i]["2.3"].ToString();
