                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    for (int i = 0; i < grd_order.Rows.Count; i++)
                    {
                        ...
                        if (isChecked == true)
                        {
                            ...
                            {
                                int Order_Status = int.Parse(grd_order.Rows[i].Cells[12].Value.ToString());
                                int Order_Progress = int.Parse(grd_order.Rows[i].Cells[11].Value.ToString());
        ...
        private void txt_Order_number_TextChanged(object sender, EventArgs e)
        {
            ...
            if (dtselect.Rows.Count > 0)
            {
                ...
                for (int i = 0; i < dtselect.Rows.Count; i++)
                {
                    ...
                    grd_order.Rows[i].Cells[8].Value = dtselect.Rows[i]["Order_Status"].ToString();
                    grd_order.Rows[i].Cells[9].Value = dtselect.Rows[i]["Progress_Status"].ToString();
                    grd_order.Rows[i].Cells[10].Value = dtselect.Rows[i]["Date"].ToString();
                    grd_order.Rows[i].Cells[11].Value = dtselect.Rows[i]["Order_Progress"].ToString();
                    grd_order.Rows[i].Cells[12].Value = dtselect.Rows[i]["Order_Status_Id"].ToString();
                    grd_order.Rows[i].Cells[13].Value = dtselect.Rows[i]["Order_ID"].ToString();
                    grd_order.Rows[i].Cells[14].Value = dtselect.Rows[i]["Order_Type_Id"].ToString();
                    grd_order.Rows[i].Cells[15].Value = dtselect.Rows[i]["stateid"].ToString();
        ...
        private void grd_order_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (Rb_Move_To_Tier1Abs.Checked == true)
            {
                ...
                if (e.ColumnIndex == 2)
                {
                    ...
                    Ordermanagement_01.Order_Entry OrderEntry = new Ordermanagement_01.Order_Entry(int.Parse(grd_order.Rows[e.RowIndex].Cells[13].Value.ToString()), User_id, Convert.ToString(User_Role_ID));
                    OrderEntry.Show();
                }
            ...
            else if (rbtn_Move_Tier2_Inhouse.Checked == true)
            {
                ...
                if (e.ColumnIndex == 2)
                {
                    ...
                    Ordermanagement_01.Abstractor.Abstractor_Order_View OrderEntry = new Ordermanagement_01.Abstractor.Abstractor_Order_View(int.Parse(grd_order.Rows[e.RowIndex].Cells[13].Value.ToString()), User_id,User_Role_ID.ToString());
                    OrderEntry.Show();
                }
            }
